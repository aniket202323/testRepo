...
/*=====================================================================================================================
Local Function: fnLocal_CTS_Appliance_Transitions
=====================================================================================================================
 ...
 1.1			2021-01-21		F.Bergeron				Add backward/forward query direction
 1.2			2023-06-26		U. Lapierre				Adapt for Code review


Testing Code

 SELECT * FROM fnLocal_CTS_Appliance_Transitions(1018702, 1, NULL,NULL,'BACKWARD')


==================================================================================================*/
CREATE   FUNCTION [dbo].[fnLocal_CTS_Appliance_Transitions] 
(
	@Event_Id 				INTEGER,
...
BEGIN
	...
	BEGIN /* @ProductTransitionOnly = 1 */
		...
		END /* @ProductTransitionOnly = 1,Start_Time IS NULL */
		ELSE 
	...
	UPDATE @Output SET Exit_time = 
	(SELECT TOP 1 timestamp FROM dbo.event_components WHERE source_event_id = appliance_id AND timestamp > Enter_time ORDER BY timestamp ASC);
