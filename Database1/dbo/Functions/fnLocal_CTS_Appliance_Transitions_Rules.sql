...
--------------------------------------------------------------------------------------------------
-- Local Function: fnLocal_CTS_Appliance_Transitions_Rules
--------------------------------------------------------------------------------------------------
-- Author				:	Francois Bergeron (AutomaTech Canada)
-- Date created			:	2021-11-05
-- Version 				:	1.0
-- Description			:	Get appliance location
--							The purpose of this function is to retreive the current or past locations of an appliance useing rules.
--							
...
--Testing Code
--------------------------------------------------------------------------------------------------
-- SELECT * FROM fnLocal_CTS_Appliance_Transitions_Rules(1018702, 0, NULL,GETDATE())


--------------------------------------------------------------------------------------------------
CREATE FUNCTION [dbo].[fnLocal_CTS_Appliance_Transitions_Rules] 
(
	@Event_Id 				INTEGER,
