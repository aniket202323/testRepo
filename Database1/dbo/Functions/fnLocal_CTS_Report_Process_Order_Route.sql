...
SELECT * FROM [fnLocal_CTS_Report_Process_Order_Route](15072) 
*/

--CREATE FUNCTION [dbo].[fnLocal_CTS_Report_Appliance_History]
CREATE FUNCTION [dbo].[fnLocal_CTS_Report_Process_Order_Route]
(
...
BEGIN
	...
	VALUES	(0,@groupId,'Title bar','#000080','#FFFFFF','Process order',NULL,NULL),
			...
			(0,@groupId,'Header',NULL,NULL,'Process order','Product code','Product_desc')
