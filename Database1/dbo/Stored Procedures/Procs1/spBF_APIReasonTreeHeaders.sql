/*
Get Reason Tree Header data for a set of production units.
@PUId                -production unit
@TreeType            -Reason Header Type
1 - ReasonHeader 
2 - ActionHeader 
3 - NPTHeader 	 
 	 EXECUTE spBF_APIReasonTreeHeaders '1', 1 	 
*/
CREATE PROCEDURE [dbo].[spBF_APIReasonTreeHeaders]
@Id                nvarchar(max), 
@TreeType  	    	    	    	  Int = 1,
@EventType               Int = 2
AS
