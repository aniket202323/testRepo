...
*/
CREATE PROCEDURE [dbo].[spBF_OEEGetDataForOrders_Bak_177]
...
INSERT INTO @SortedUnits(UnitId ,UnitDesc, UnitOrder, LineId,  Line, OEEType)
 	 SELECT UnitId ,UnitDesc, UnitOrder, LineId,  Line, OEEType
 	 FROM @Units 
