CREATE Procedure [dbo].[spBF_PerformanceDistribution]
@UnitList text = null,
...
SET NOCOUNT ON
--EXECUTE dbo.spDBR_PerformanceDistribution @UnitList,@StartTime,@EndTime,@FilterNonProductiveTime,@ProductFilter,@CrewFilter,@ShiftFilter,@LocationFilter , @FaultFilter,@ReasonFilter1,
--@ReasonFilter2,@ReasonFilter3,@ReasonFilter4,@ShowTopNBars,@InTimeZone,@TimeOption
if (@LocationFilter = -1)
begin
 	 ...
 	 Begin
 	  	 ...
 	  	 While @@Fetch_Status = 0
 	  	  	 Begin    
 	  	  	  	 ...
 	  	  	  	 SELECT @OutsideareaCategory='',@UnavailableCategory=''
 	  	  	  	  	  	 ...
 	  	  	  	  	  	 If @Level3Name Is Not Null 
 	  	  	  	  	  	  	 Select @Level4Name = level_name
 	  	  	  	  	  	  	   ...
 	  	  	  	  	  	  	   Where Tree_Name_id = @TreeId and
 	  	  	  	  	  	  	  	  	 Reason_Level = 4
 	  	  	  	  	 End
 	  	  	  	 Select @SQL1 = 'Select d.Start_Time, d.Source_PU_Id, Case When '''+@OEEType+''' = ''Time Based'' Then d.Reason_Level2 Else d.Reason_Level1 End Reason_Level1, d.Reason_Level2, d.Reason_Level3, d.Reason_Level4' 	  
 	  	  	     ...
 	  	  	     Select @SQL3 = ' '
 	  	  	  	 If @LocationFilter Is Not Null Select @SQL3 = @SQL3 + ' and d.Source_PU_Id = ' + convert(nvarchar(10), @LocationFilter)
 	  	  	  	 If @ReasonFilter1 Is Not Null Select @SQL3 = @SQL3 + ' and d.Reason_Level1 = ' + convert(nvarchar(10), @ReasonFilter1)
 	  	  	  	 If @ReasonFilter2 Is Not Null Select @SQL3 = @SQL3 + ' and d.Reason_Level2 = ' + convert(nvarchar(10), @ReasonFilter2)
 	  	  	  	 If @ReasonFilter3 Is Not Null Select @SQL3 = @SQL3 + ' and d.Reason_Level3 = ' + convert(nvarchar(10), @ReasonFilter3)
 	  	  	  	 If @ReasonFilter4 Is Not Null Select @SQL3 = @SQL3 + ' and d.Reason_Level4 = ' + convert(nvarchar(10), @ReasonFilter4)
 	  	  	  	 If @FaultFilter Is Not Null
 	  	  	  	  	 Begin
 	  	  	  	  	  	 ...
 	  	  	  	  	  	 If @FaultId Is Not Null
 	  	  	  	  	  	  	 Select @SQL3 = @SQL3 + ' and d.TEFault_Id = ' + convert(nvarchar(10), @FaultId)              
 	  	  	  	  	 End
 	  	  	  	 ...
 	  	  	  	 */
 	  	  	  	 declare @ShiftInterval int, @ShiftOffset int, @ShiftStart datetime, @ShiftEnd datetime, @ShiftDesc nvarchar(10), @TimePart nvarchar(50)
 	  	  	  	 ...
 	  	  	  	 select @TimePart = convert(nvarchar(10), DatePart(hh, @curStartTime)) + ':' + convert(nvarchar(10),DatePart(mi, @curStartTime)) + ':' + convert(nvarchar(10), DatePart(ss, @curStartTime))
 	  	  	  	 ...
 	  	  	  	 begin
 	  	  	  	  	 insert into #Shift (ShiftDesc, ShiftStart, ShiftEnd) values ('Shift' + convert(nvarchar(2),@ShiftNum), @ShiftStart, @ShiftEnd)
...
--Display duration only in minutes
/*
if @total > 120
begin
