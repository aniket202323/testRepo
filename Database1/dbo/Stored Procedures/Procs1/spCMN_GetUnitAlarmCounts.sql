CREATE Procedure dbo.spCMN_GetUnitAlarmCounts
@Unit int,
@StartTime datetime, 
@EndTime datetime,
...
While @@Fetch_Status = 0
  Begin
    If @VariableList Is Null
      Select @VariableList = convert(varchar(25),@@VariableId)
    Else
      Select @VariableList = @VariableList + ',' + convert(varchar(25),@@VariableId)
 	  	 Fetch Next From Alarm_Cursor Into @@VariableId
  End
Close Alarm_Cursor
