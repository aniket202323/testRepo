Create Procedure dbo.spDBR_Get_Dialogue_Path
 	 @UserID int,
 	 @Node varchar(50)
AS
...
--Check Port 	 
 	 ...
 	 --select @server as Server, @path as Path, 'dialogue.aspx' as Page
 	 select @server+":"+@port as Server, @path as Path, 'dialogs/dialog.aspx' as Page
