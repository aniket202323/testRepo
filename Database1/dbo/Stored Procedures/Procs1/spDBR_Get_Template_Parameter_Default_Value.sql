Create Procedure dbo.spDBR_Get_Template_Parameter_Default_Value
...
AS
 	 ...
 	 begin
 	  	 ...
 	  	 from 
 	  	  	 ...
 	  	  	 dashboard_parameter_types pt,
 	  	  	 dashboard_template_parameters tp,
 	  	  	 dashboard_parameter_default_values d
 	  	 ...
 	  	 declare @param_value varchar(4000)
 	  	 declare @presentation_value varchar(100)
 	  	 declare @default_value_id varchar(100)
 	  	 declare @datatable_header varchar(100)
 	  	 
 	  	 /*the following line simply gets the number of parameter rows (we just count the first parameter to know how many rows are in the set*/
 	  	 ...
 	  	 begin 	  	 
 	  	  	 ...
 	  	  	 SET @sqlstmt = /*Convert(nvarchar,*/ @sp_name/*)*/
 	  	  	 ...
 	  	  	 begin
 	  	  	  	 ...
 	  	  	  	 set @sqlstmt =  @sqlstmt + N' [' + Convert(nvarchar, @Param_Value) + N']'
 	  	  	  	 /*set @sp_name = (@sp_name + ' ' +  Convert(nvarchar, @Param_Value)*/
 	  	  	  	 ...
 	  	  	  	 delete from #column_parameters where parameter_number = @paramnumber and row_id = @row and column_id = @column
 	  	  	 end
 	  	 ...
 	  	 select d.dashboard_parameter_default_value_id, 
 	 ...
 	 begin
 	  	 insert into #default_Values select '<None>' as dashboard_parameter_default_value_id, 1 as dashboard_parameter_row, 1 as dashboard_parameter_column, '<None>' as dashboard_parameter_value, '<None>' as dashboard_datatable_header
