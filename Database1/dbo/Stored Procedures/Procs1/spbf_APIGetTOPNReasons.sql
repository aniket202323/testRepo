/*
Get Top Selected Reason Tree for a set of production units.
@PUId                -Production unit
@ShowTopNBars        -Top N Reasons
@TreeType 	  	  	  - Type of reason
1 - Reason
2 - Action 
 	 EXECUTE spbf_APIGetTOPNReasons '1', 1, 1 	 
*/
CREATE PROCEDURE [dbo].[spbf_APIGetTOPNReasons]
@PUId int,
@ShowTopNBars int = 5,
@TreeType int = 1,
@EventType Int = 2
