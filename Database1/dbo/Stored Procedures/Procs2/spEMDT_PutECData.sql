CREATE PROCEDURE  dbo.spEMDT_PutECData
 	 @EcId 	  	  	 Int,
 	 @PUId 	  	  	 Int,
 	 @Alias 	  	  	 nvarchar(50),
 	 @Trigger 	  	 Bit,
...
INSERT INTO Audit_Trail(Application_Id,User_id,Sp_Name,Parameters,StartTime)
 	 VALUES (1,@User_Id,'spEMDT_PutECData',
...
Select @FieldId = ED_Field_Id  
  ...
  Where  ED_Field_Type_Id = 3 
declare @ECV_Id int
insert into event_configuration_values(value) values ('PT:' + @Tag)
