Create Procedure dbo.spEMEC_DeleteECData
@EC_Id int,
@User_Id int,
@ECV_Id int = NULL
AS
...
INSERT INTO Audit_Trail(Application_Id,User_id,Sp_Name,Parameters,StartTime)
 	 VALUES (1,@User_Id,'spEMEC_DeleteECData',
...
Insert Into #Ids
  select ECV_Id 
   ...
   join ed_fields f on f.ed_field_id = d.ed_field_id and f.ed_field_type_id = 10 --and Max_Instances > 1
  where ec_id = @EC_Id 
