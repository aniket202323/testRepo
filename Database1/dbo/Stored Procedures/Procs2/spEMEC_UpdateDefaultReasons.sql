Create Procedure dbo.spEMEC_UpdateDefaultReasons
...
INSERT INTO Audit_Trail(Application_Id,User_id,Sp_Name,Parameters,StartTime)
 	 VALUES (1,@User_Id,'spEMEC_UpdateDefaultReasons',
...
if @Type = 0
  Begin
 	 ...
 	 Update event_subtypes set cause_tree_id = @TreeId,
  ...
  End
 	 ...
 	 Update event_subtypes set action_tree_id = @TreeId,
