CREATE PROCEDURE dbo.spEM_SystemCompleteActivities @ReturnStatus  INT          = NULL OUTPUT,
...
BEGIN
    ...
    WHILE @SCLoopStart <= @SCLoopEnd
        BEGIN
            ...
            SET @SCComment = 'System completed the activity '+CAST(@SCActivityId AS nvarchar(20))+'';
