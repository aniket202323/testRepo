...
CREATE   PROCEDURE [dbo].[spLocal_BDAT_EvaluateBatchDates]

--=====================================================================================================================
--	Name:		 		spLocal_BDAT_EvaluateBatchDates
...
/*
	...
	EXEC	@intErrorCode = dbo.spLocal_BDAT_EvaluateBatchDates
...
SET NOCOUNT ON
	...
	BEGIN
		SET @Message = 'Date and time is NULL. Check for error messages'
	END
	...
	IF DATEDIFF(day,@EndDate,GETDATE()) > 7 and DATEDIFF(day,@StartDate,GETDATE()) <  7
	BEGIN	
		SET @Message = 'The Batch is having End Date more than last 7 Days'
	END
