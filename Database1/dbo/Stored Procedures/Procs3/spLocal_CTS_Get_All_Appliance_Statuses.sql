...
--------------------------------------------------------------------------------------------------
-- Stored Procedure: spLocal_CTS_Get_All_Appliance_Statuses
--------------------------------------------------------------------------------------------------
...
exec [dbo].[spLocal_CTS_Get_All_Appliance_Statuses] 10415


*/

-------------------------------------------------------------------------------
CREATE   PROCEDURE [dbo].[spLocal_CTS_Get_All_Appliance_Statuses]
...
@tfIdApplianceType				int,
@TableIdProdUnits				int

DECLARE @output TABLE(
ProdStatus_Id INTEGER, 
ProdStatus_Desc VARCHAR(50),
ProdStatus_Type	VARCHAR(50))
...
SET @tfIdApplianceType	= (	SELECT table_field_id 
							FROM dbo.table_fields WITH(NOLOCK) 
							WHERE tableid = @TableIdProdUnits 
								AND Table_Field_Desc = 'CTS Appliance type'
						)
