...
--------------------------------------------------------------------------------------------------
-- Stored Procedure: spLocal_CmnMobileAppGetPalletInventory_test
--------------------------------------------------------------------------------------------------
...
--
/*-------------------------------------------------------------------------------
--The stored proc <spLocal_CmnMobileAppGetPalletInventory_test> will
...
--------------------------------------------------------------------------------------------------
/*
exec [dbo].[spLocal_CmnMobileAppGetPalletInventory_test]
		62,
		0,
		0
...
-------------------------------------------------------------------------------
CREATE PROCEDURE [dbo].[spLocal_CmnMobileAppGetPalletInventory_test]
		@PathID						int,
		@DebugFlagOnLine			int,
		@DebugFlagManual			int
...
SET @CallingSP = 'spLocal_CmnMobileAppGetPalletInventory_test'
...
BEGIN
	...
	INSERT @tProdUnits (EquipmentId,puid,S95Id,IsBulkMaterial)
			SELECT DISTINCT eu.equipmentId,
							a.pu_id,
							eu.S95Id,
							r.IsBulkMaterial
