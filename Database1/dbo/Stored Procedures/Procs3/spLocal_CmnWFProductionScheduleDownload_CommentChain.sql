...
-- Stored Procedure: spLocal_CmnWFProductionScheduleDownload        

--------------------------------------------------------------------------------------------------        

-- Author    : AJudkowiczm, Simon Poon GE        

-- Date created   : 11-Apr-05        

-- Version     : Version <2.0>        

-- SP Type    : Workflow        

-- Caller    : Called by Process order downlaod workflow        

-- Description   : Process B2MML file from Open enterprise to create/Edit Process order        
...
--Task 10 – BOM  Processing – Populate MCR and MCRP        

--Task 11 – Handle Production plan in case of multiple Production Request        

--Task 12 – Handle PP Field not supported by ResultSet        

--Task 13 – Handle PP UDPs – Create UDP for MPRP and populate mprp for ppid        

--Task 14 – Handle <Any> UDPs for the ppid (Any for ProductionRequest)        

--Task 15 – Add / change production setup        

--Task 16 – Handle <Any> UDP elements for MPR        

--Task 17 – Handle <Any> SPs        

--Task 18 – Send Dummy Result Sets        

--Task 19 – Send Dummy Result Sets        

--Task 20 - Sens Result Sets back        
...
-- 1.0   2005-04-11  A. Judkowicz  Initial Release        

        

--    13-Feb-12  S.Poon    Capture and Populate PP Comment        

--             Capture and Populate ppr.BatchId        

--             Capture and Populate Delivered Qty        

--             Capture and Populate ERPOrderStatus        

--             Populate BatchId to PSD        

        

--    21-Feb-12  S.Poon    Has Implemented 37 Use Cases for MOT                  

        

--    22-Feb-12  S.Poon    a. Populate the alternate material        

--             b. No Matter what, update the Delivered Qty        

--        

--    02-Mar-12  S.Poon    Add Site EquipmentId and MPR Equipment as Production        

--             Plan UDP        

--        

--    05-Mar-12  S.Poon    Fix comment update        

--             disable BatchId update (Production_Setup_Detail)        

--             ignore the path to identify the PO,        

--             add logic to change the path of an PO        

--        

--    06-Mar-12  S.Poon    Fix a bug in ErrorCode -163 - Convert(varchar(25), @ProdCode)        

--             Use the Name instead Ids for the UDPs        

        

--    29-Mar-12  S.Poon    1. Move the BatchId, ExpirationDate and DeliveredQty        

--             2. Comparison of BatchId, ExprationDate and DeliveryQty at PP level        

--             3. Fix the bugs - do not update other things for use cases 22,23,30-33        

--        

--    10-Apr-12  S.Poon    Coalesce(Convert(varchar(25), mpr.PathId), 'NoPathId')        

--        

--    13-April-12  Simon Poon   Add similar Coalesce(Convert(varchar(25), mpr.PathId), 'NoPathId')        

--             at Task 6.02 and Task 8.02        

--             Add conditions at Err=-101        

        

-- 2.0   2012-05-24  U. Lapierre   Modify SP to follow P&G standards        

--        

--     2012-05-30  S.Poon    Modify SP for        

--          TestCase 28 - No change for EquipmentIdSite and EquipmentIDStorageZone         

--             ErrCode -170 Null @PathId        

--                     

--    2012-05-31  S.Poon    Fix the ErrorAndWarning:Reference NULL Issue        

--        

--    2012-06-11  S.Poon    Add condition to --return the ErrorAndWarning:Reference        

--             DELETE the row with NULL errorCode        

        

--    2012-06-19  S.Metlitski   Add the @FlgRemoveLeadingZeros Logic        

--             Add the @FlgInclProdInBOMFDesc Logic        

--    2012-07-03  S.Poon    Put back the UserGeneral 1-3 at the ResultSets        

--    2012-07-18  U.Lapierre   Make datatype lower case        

--    2012-07-20  S.Poon    Task 2.03 -         

--             Get all the Description Field and Concatenate them all in one        

--             <Description>Comment01</Description>        

--             <Description>Comment02</Description>        

--             <Description>Comment03</Description>        

        

--    2012-07-26  S.Metlitski   When @FlgInclProdInBOMFDesc = 1 BOM Formulation Description constructed as         

--             concatenation of 'Product Description':'Process Order'        

--    2012-08-02  S.Poon    - Fix the scenario        

--               Assign ALT material to Primary Materials        

--               In case of 2 primary materials with same code, use EquipmentId to identify        

--             - Disable this feature because it may crash the download         

--               if there are 2 same material items in the BOM        

--               MERGE @tblBOMItemAttributesChanges        

--             - Verify the MCR Storage Location Mapping        

--        

--             There is 1 issue        

--             Why the legacy SP put the standard qty to 1,        

--             even though put it to MRP.Qty, it is still '1'        

--             need to verify with Neal about the actual download        

-- 2.12   2012-09-05  S.Poon    Fix the fault -169 and -142        

-- 2.16   2013-02-27  M.Kravchenko  Added a new flag @FlgRemoveLeadingZerosPO Logic        

--             Ignore DUMMY Product. Delete from MCR         

-- 2.17   2013-03-04  U.Lapierre   WITH ENCRYPTION added         

-- 2.19   2013-03-18  U.Lapierre   Make comments to have a carriage --return between each line         

-- 2.20   2014-02-06  U.Lapierre   Allow download of Material Reservation id & Sequence        

-- 2.21   2014-05-30  U.Lapierre   If SAP send expiration date 0000-00-00, create order with 0        

-- 2.22   2014-06-16  U.Lapierre   Remove leading zero when comparing the alternate material with the primary material        

--2.23   2014-07-25      Rajendran BalaMurugan(TCS) Changed the input from TEXT to NTEXT        

--2.24    2014-11-10  Rajedran BalaMurugan (TCS) Commented out the part where the PO status was set to error for         

--                 MCR creation and checks.         

--2.25   2014-11-21  Rajedran BalaMurugan (TCS) Added the code to update @tpr commentid to commentid for Existing POs        

--2.26   2014-09-24      Rajendran BalaMurugan (TCS) Added the temp table code to create add alternate material quantity to Main material        

--2.27   2015-01-05  Rajendran BalaMurugan (TCS) Added logic to set PO to error status if No resource path is sent for component Material.        

--               and also sent the BOMchanged flag to validate PE PO validate user activity             

--2.28   2015-01-09  Rajendran BalaMurugan (TCS) Added MaterialOriginGroup Logic for Comparison for calling PE user activity for PO validation.        

--2.29   2015-02-10  Rajendran BalaMurugan (TCS) Added code to update @tpr comment_Text to comment for Existing POs.        

--2.30   2015-07-21  Rajendran BalaMurugan (TCS) Added code from GE to fix the leading Zero's issue.  

--2.31   2015-10-07  Rajendran BalaMurugan (TCS) Changed code to fetch produced material Error from an UDP.

--2.32   2016-03-24  Rajendran BalaMurugan (TCS) condition to check if the line PE line if not dont keep PO in Error status for no resource  path in component material data.    

--2.33	 2016-03-30  Rajendran BalaMurugan (TCS) Added condition to encounter Family care Parent/child Path relationship

--================================================================================================        

CREATE PROCEDURE [dbo].[spLocal_CmnWFProductionScheduleDownload_CommentChain]    

    @XML                       NTEXT    -- The B2MML Production Schedule Message           
...
WHERE lstorage.EquipmentElementLevel = 'StorageZone'          
			...
			Select '@tMPRPattritbutes', * From @tMPRP
...
IF @FlgPPExisted = 1        
 ...
 FROM @tPR        
 Select 'Batista', * From @tPR
         Select 'Balasachin', * From @tER
...
IF @FlgPPExisted = 1        
 ...
 WHERE ( OldItemValue <> NewItemValue         
    ...
    OR OldItemValue IS NOT NULL AND NewItemValue IS NULL        
		   ...
		   Select 'Tiger', * From @tblPPChanges
		   Select 'Consumption',* From @tmcr
...
------------------------------------------------------------------------------        
 ...
 IF (SELECT COUNT(*) FROM @tblBOMItemChanges) > 0        
  ...
  SELECT @FlgBOMItemChanged = 1        
   ...
   SELECT 'tblBOMItemChangesOldSachin', * FROM @tblBOMItemChangesOld        

   SELECT 'tblBOMItemChangesNewRoger', * FROM @tblBOMItemChangesNew        

   SELECT 'tblBOMItemChangesBala', * FROM @tblBOMItemChanges        
...
IF @DebugFlag = 1        
 ...
 SELECT @UseCaseId    AS UseCaseId,        
   ...
   @FlgUnlockedData  AS FlgUnlockedData        
		...
		Select '@UseCaseIdBala', @UseCaseId
...
IF @PPCreateAction = 0 AND @PPUpdateAction = 0 AND @FlgAllowDataChange = 0        
 ...
 END        
		...
		Select '@PPCreateAction', @PPCreateAction
		Select '@PPUpdateAction', @PPUpdateAction
		Select '@FlgAllowDataChange', @FlgAllowDataChange
IF @PPCreateAction = 0 AND @PPUpdateAction = 1 AND @FlgAllowDataChange = 0        
 ...
 WHERE pp_Id = @PPId        
        ...
        Select '@PPUpdateStatusStrsachin', @PPUpdateStatusStr
 ...
 WHERE PP_Status_Desc = @PPUpdateStatusStr        
        ...
        Select '@PPStatusIdError', @PPStatusId
...
SELECT  @Rows = 0,        
  ...
  Comment = Convert(Varchar(50),c.Comment_Text) 
