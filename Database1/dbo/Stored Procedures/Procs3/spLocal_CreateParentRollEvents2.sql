...
05/23/02 MKW Removed QCS Weight Conversion from this routine so only have one conversion set by the parameter on the QCS Data unit.  
*/  
CREATE procedure dbo.spLocal_CreateParentRollEvents2  
  ...
  @Turnover_Num  = right(@Turnover_Id, 3)  
    ...
    @QCS_Weight_TimeStamp = TimeStamp  
          ...
          If @QCS_Weight_TimeStamp Is Not Null  
               ...
               If @Closer_Events = 0  
                    Select @QCS_Weight = Final_Dimension_X  
                    From Event_Details  
                    Where Event_Id = @QCS_Weight_Event_Id  
               End  
  
          /* Get additional data */  
          Select @QCS_Roll_Weight_Precision = Var_Precision  
          From Variables  
          Where Var_Id = @QCS_Roll_Weight_Var_Id  
    ...
    rtrim(ltrim(@Position_Label)) + @Julian_Date  
                    ...
                    ************************************************************************************************************************************************************************/  
                    ...
                    Execute spServer_DBMgrUpdEvent @Roll_Event_Id   OUTPUT, @ULID, @Roll_PU_Id, @Roll_TimeStamp, Null, Null, @Default_Status_Id, 1, 0, 6, Null, Null, Null, Null, Null, 1  
                    ...
                    ************************************************************************************************************************************************************************/  
                    ...
                    Execute spServer_DBMgrUpdEventComp 1, @Roll_Event_Id, @Component_Id OUTPUT, @Turnover_Event_Id, 0, 0, 0, @Roll_Ratio, 0, 1, Null  
             ...
             /************************************************************************************************************************************************************************  
                    ...
                    *                                                                                            QCS Roll Weight                                                                                                         *  
                    ************************************************************************************************************************************************************************/  
                    If @QCS_Roll_Weight_Var_Id Is Not Null And @QCS_Roll_Weight_Var_Id > 0 And @QCS_Weight > 0  
                         Begin  
                         Insert Into #VariableUpdates (Var_Id, PU_Id, Result, Result_On)   
                         Values (@QCS_Roll_Weight_Var_Id, @Roll_PU_Id, ltrim(str(@QCS_Weight*@Roll_Ratio/100, 25, @QCS_Roll_Weight_Precision)), @Roll_TimeStamp)  
                         End  
