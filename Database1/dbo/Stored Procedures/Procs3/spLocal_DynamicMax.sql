...
Stored Procedure: spLocal_DynamicMax  
Author:   Matthew Wells (MSI)  
Date Created:  08/27/01  
  
Description:  
=========  
I think this has been covered by a VB Script.  
...
CREATE procedure dbo.spLocal_DynamicMax  
...
Select @OutputValue = convert(varchar(25),Max(SpDResult))  
   From @SpDVars  
