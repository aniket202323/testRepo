...
--------------------------------------------------------------------------------------------------
--================================================================================================
-- 1.0		2021-01-15		Julien B. Ethier	Created from PE's spLocal_MPWS_CmnPrIMESimulationShortPallet
--------------------------------------------------------------------------------------------------

CREATE PROCEDURE [dbo].[spLocal_MPWS_CmnPrIMESimulationShortPallet]
...
Exec spLocal_MPWS_CmnPrIMESimulationShortPallet
	@OutputValue				OUTPUT,
	'20-Aug-2018 17:10',				
	2002
...
SET @SPNAME = 'spLocal_MPWS_CmnPrIMESimulationShortPallet'
SELECT @Now = GETDATE()
SET @Count = 0
