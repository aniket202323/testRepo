...
CREATE 	PROCEDURE [dbo].[spLocal_MPWS_INVN_GetRCMByCriteriaDup_Reconcile]
...
exec  spLocal_MPWS_INVN_GetRCMByCriteriaDup_Reconcile '','3379','','7,8,9,21','','','','','all items',@ErrorCode OUTPUT,@ErrorMessage OUTPUT
*/
...
-- Validate parameters
-------------------------------------------------------------------------------
IF		@RowCountEV = 0 AND @RowCountLU = 0 AND	@PUId IS NULL
...
--GRANT EXECUTE ON [dbo].[spLocal_MPWS_INVN_GetRCMByCriteria] TO [public]
