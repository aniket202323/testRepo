...
/*	-------------------------------------------------------------------------------
	dbo.spLocal_MPWS_PLAN_ContainerExitKanban
		
	This sp returns header info for [spLocal_MPWS_PLAN_ContainerExitKanban]
...
CREATE PROCEDURE [dbo].[spLocal_MPWS_PLAN_ContainerExitKanban]
