...
EXEC dbo.spLocal_MPWS_RPT_Inventory_Details @ErrorCode OUTPUT, @ErrorMessage OUTPUT, '', ''
 
DECLARE @ErrorCode INT, @ErrorMessage VARCHAR(500)
EXEC dbo.spLocal_MPWS_RPT_Inventory_Details @ErrorCode OUTPUT, @ErrorMessage OUTPUT, '', 'rm03'
 
DECLARE @ErrorCode INT, @ErrorMessage VARCHAR(500)
EXEC dbo.spLocal_MPWS_RPT_Inventory_Details @ErrorCode OUTPUT, @ErrorMessage OUTPUT, 'inventory', ''
...
CREATE  PROCEDURE [dbo].[spLocal_MPWS_RPT_Inventory_Details]
