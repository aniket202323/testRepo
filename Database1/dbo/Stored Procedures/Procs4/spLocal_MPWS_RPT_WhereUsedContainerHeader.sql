...
/*	-------------------------------------------------------------------------------
	dbo.spLocal_MPWS_RPT_WhereUsedContainerHeader
	
	If query contains any results it should return Success and the table should return the material information
...
EXEC dbo.spLocal_MPWS_RPT_WhereUsedContainerHeader @ErrorCode OUTPUT, @ErrorMessage OUTPUT, 'RMCIT-221'
...
CREATE  PROCEDURE [dbo].[spLocal_MPWS_RPT_WhereUsedContainerHeader]
