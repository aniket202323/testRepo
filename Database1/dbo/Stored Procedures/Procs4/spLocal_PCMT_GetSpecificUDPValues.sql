...
CREATE PROCEDURE [dbo].[spLocal_PCMT_GetSpecificUDPValues]
/*
*****************************************************************************************************************
Stored Procedure:		spLocal_PCMT_GetSpecificUDPValues
...
SET @intTableId = (SELECT tableid FROM dbo.tables WHERE tablename = 'Variables')

INSERT #IDENTITY (Item_Desc, Var_Id)
	SELECT DISTINCT tfv.value, @txtVarId
...
EXEC sp_executesql @vcrSQLCommand, @vcrSQLParams, @intTableFieldId, @intVarId, @intTableId
