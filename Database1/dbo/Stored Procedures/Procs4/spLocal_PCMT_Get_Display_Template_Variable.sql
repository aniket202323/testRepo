...
----------------------------------------[Creation Of SP]-----------------------------------------
CREATE PROCEDURE [dbo].[spLocal_PCMT_Get_Display_Template_Variable]
...
BEGIN
	...
	INSERT INTO @tmp(var_desc, pl_desc, pu_desc, pug_desc)
	SELECT	DISTINCT	v.var_desc, pl.pl_desc, pu.pu_desc, pug.pug_desc
...
BEGIN
	...
	INSERT INTO @tmp(var_desc, pl_desc, pu_desc, pug_desc)
	SELECT	v.var_desc, pl.pl_desc, pu.pu_desc, pug.pug_desc
