...
----------------------------------------[Creation Of SP]-----------------------------------------
CREATE PROCEDURE [dbo].[spLocal_PCMT_Get_ProductionUnit_VariableAdd]
/*
-------------------------------------------------------------------------------------------------
...
Description		: 	This SP returns the lines that meet the search requirements in the form to edit variables as production unit
					PCMT Version 1.30
-------------------------------------------------------------------------------------------------
...
SELECT Distinct pu.pu_id, pu_desc
FROM 
	dbo.prod_units pu
