...
CREATE	PROCEDURE [dbo].[spLocal_PDPBFGetSafetyIncidentDetails]
		@TransType		INT		= 0			-- 1: Last 24 hours, 0: Last 4 days
AS
-------------------------------------------------------------------------------
-- This SP retrieves the safety incident details mashup
--
--
-- Date         Version Build  Author								Notes
-- 26-Aug-2016  001     001    Alex Judkowicz (GE Digital)			Initial development
/*
exec spLocal_PDPBFGetSafetyIncidentDetails 1
*/
-------------------------------------------------------------------------------
SET NOCOUNT ON
-------------------------------------------------------------------------------
...
-- Site-specific logic
-------------------------------------------------------------------------------
INSERT	@tOutput (Field01Value) VALUES ('Disabled')
/*
