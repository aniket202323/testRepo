...
Description:  
=========  
returns All the Valid Team (Crew) Name for the Production Unit in Question - Assumes use of the ScheduleUnit paramter in Exteded info field  
...
CREATE PROCEDURE dbo.spLocal_PE_GetTeams_2_1_2  
...
insert into #Teams(Team) (Select distinct crew_desc  from crew_schedule cs Join #Schedule_puid sp on sp.schedule_puid = cs.PU_ID)  
