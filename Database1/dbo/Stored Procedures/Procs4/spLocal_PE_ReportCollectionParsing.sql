...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- ========		===========		==========				===========================================================================================================
-- 1.0			01-Jul-2020		A.Metlitski				Original. derived from spCmn_ReportCollectionParsing to fix the issue of limiting AttruteValue to 50 chars
-------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- Desc:
...
/*
SET nocount on
Exec spLocal_PE_ReportCollectionParsing 
...
*/
--
CREATE  PROCEDURE  dbo.spLocal_PE_ReportCollectionParsing
