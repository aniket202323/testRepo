--=====================================================================================================================
--	Name:		 		spLocal_PG_Batch_GetAvailableBatches_TestbyPratik
...
/*
	...
	EXEC	@intErrorCode = dbo.spLocal_PG_Batch_GetAvailableBatches_TestbyPratik
...
*/
--=====================================================================================================================
CREATE PROCEDURE [dbo].[spLocal_PG_Batch_GetAvailableBatches_TestbyPratik](
...
--=================================================================================================================
	...
	BEGIN
		...
		BEGIN
			...
			update tab set tab.ProcessOrder = pp.Process_Order  from #tblAvailableBatches tab join
				Production_Plan pp on tab.BatchId = pp.User_General_1 
