...
CREATE	PROCEDURE [dbo].[splocal_LastThreeShiftQATriggerStatus] 
		@LineId		VARCHAR(255),
		@Shift		INT		
AS
------------------------------------------------------------------------------
...
/*
splocal_LastThreeShiftQATriggerStatus 'BC Line 4',3
splocal_LastThreeShiftQATriggerStatus 'BC Line 4',2
splocal_LastThreeShiftQATriggerStatus 'BC Line 4',1
*/
-------------------------------------------------------------------------------
--Initial settings
-------------------------------------------------------------------------------
