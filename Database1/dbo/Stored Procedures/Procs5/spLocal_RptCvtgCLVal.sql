...
-- Revision 6.49  Last Update: 2009-04-13  Jeff Jaeger  
--  
...
2009-04-13 Jeff Jaeger Rev6.48  
...
CREATE        PROCEDURE dbo.spLocal_RptCvtgCLVal  
--DECLARE  
 @StartTime  DATETIME,  -- Beginning period for the data.  
 @ENDTime   DATETIME,  -- ENDing period for the data.  
 @Display_id  VARCHAR(8000),  
...
--    @Display_id = '1413|1414|1438|1437|1439|1344|1345|1368|1375|1373|1397|1405|1464|1471|1478|1490|1619|1620|1848|1849|1815|1439|1811|1846|1850|1851|1813|1852',      
--    @Display_id = '804',  
--    @BYSummary = 1  
...
Update dbo.#Tests  
 ...
 IF @ErrorVar <> 0  
   BEGIN  
   INSERT @ErrorMessages (ErrMsg)  
   VALUES ('Report failed due to a mixture of numeric and non-numeric values between the result and the Reject and/or Warning Limits on one or more variables.  Go to Raw Data worksheet, filter on Data Type = VARIABLE and look for non-numeric Result, Uppe
r or Lower Reject or Warning values to identify offending variables.')  
