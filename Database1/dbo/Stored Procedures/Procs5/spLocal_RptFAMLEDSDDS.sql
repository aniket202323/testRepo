...
/****** Object:  Stored Procedure dbo.spLocal_RptFAMLEDSDDS    Script Date: 2/26/2010 11:04:16 AM ******/
CREATE PROCEDURE [dbo].[spLocal_RptFAMLEDSDDS]                                                            
/*                                                            
Stored Procedure :   [spLocal_RptFAMLEDSDDS]                                                            
Author   :     TCS                                                            
...
Test Syntax:                                                            
=====================================================================================================                                                      
Exec [dbo].spLocal_RptFAMLEDSDDS                                                          
...
V1.1.0	 28-Feb-2018  Sunil Corrected logic for Sheetbreak time calculation [FO-03258]                   
========================================================================                                               
*/                                                          
...
SELECT @CompanyName  = COALESCE (Value, 'Company Name') FROM Site_Parameters  WHERE Parm_Id = 11                                       
                                                             
SELECT @SiteName  = COALESCE(Value, 'Site Name')    FROM Site_Parameters  WHERE Parm_Id = 12                                                            
...
-- Table_Id for the dbo.Variables table (for UDP retrieval)                                                          
SET @VarTableId =                                                             
(                                         
 SELECT  TableID                                                          
...
(                                                          
  ...
  JOIN  dbo.Variables v WITH(NOLOCK) ON v.Var_Id = f.KeyID                                                          
...
Case       
 ...
 JOIN  dbo.Prod_Units pu    WITH(NOLOCK) ON pu.Pu_Id = ted.Source_Pu_Id                                                            
...
UPDATE r                                                          
 SET  Length =                                                  
 (                                           
   SELECT t.Result  FROM dbo.Tests t                                                          
...
--*********************************************************************************************************************************************                                                          
 ...
 --   of the primary table    [FO-03258 - Commenting sections 4 and 5 to calculate the correct Sheetbreak time]                                       
 --UPDATE ted1                                                          
 --SET                                                          
...
-- ----==================================================
 ...
 UPDATE #TED1 SET Duration = DATEDIFF(SS, Start_Time, End_Time) / 60.0  ---[FO-03258]
...
(                                                          
 ...
 FROM  dbo.Timed_Event_Details ted WITH(NOLOCK)                                        
 JOIN  #DownUptime l2     ON l2.Pkey = l.PKey                                               JOIN  dbo.Timed_Event_Fault tef WITH(NOLOCK) ON tef.TEFault_Id = ted.TEFault_Id                                                       
 WHERE  ted.PU_id = @ProductionPUID                                                         
 AND  (                                       
     tef.TEFault_Value > 0            
     AND                                                          
...
UPDATE pe                                                          
 ...
 (                                                          
  ...
  JOIN  dbo.Variables v WITH(NOLOCK) ON v.Var_Id = vs.Var_Id                                                          
