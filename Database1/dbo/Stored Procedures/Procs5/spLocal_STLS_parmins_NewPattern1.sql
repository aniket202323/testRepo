...
/*
--------------------------------------------------------------
Name: spLocal_STLS_parmins_NewPattern1
Purpose: Build and insert a new pattern
--------------------------------------------------------------
Build #8
...
CREATE  PROCEDURE spLocal_STLS_parmins_NewPattern1
...
IF @@ERROR > 0
	BEGIN
	RAISERROR('Insert Pattern failed.', 16, 1)
	RETURN 99
	END
