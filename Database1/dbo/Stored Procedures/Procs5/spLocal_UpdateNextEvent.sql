...
--------------------------------------------------------------------------------------------------------------------------------------------------------------  
Stored Procedure: spLocal_UpdateNextEvent  
...
CREATE procedure dbo.spLocal_UpdateNextEvent  
...
/* Get the next events' timestamps */  
Insert into @NextEvents (PU_id, Timestamp)  
Select PU_Id, Min(TimeStamp)   
From [dbo].Events  
...
/* Get the next events' ids */  
Declare NextEvent Cursor For  
Select PU_Id, TimeStamp  
From @NextEvents  
Open NextEvent  
  
Fetch Next From NextEvent Into @PU_Id, @TimeStamp  
...
*/  
     ...
     Select @Event_Id = Event_Id From [dbo].Events Where PU_Id = @PU_Id And TimeStamp = @TimeStamp  
