...
--------------------------------------------------------------------------------------------------
-- Stored Procedure: spLocal_Util_CreateUpdateMasterBOMFormulationData
--------------------------------------------------------------------------------------------------
...
-- 1.5			30-Jan-2020		A.Metlitski				Modified Q-ty Data Type to Float
-- 1.6			05-Feb-2020		A.Metlitski				Modified Q-ty Data Type to Float while parsing
--														Fixed Issue with Eng Unit Conversion
...
EXECUTE @RC = [dbo].[spLocal_Util_GetMasterBOMFormulationData] 
		@ErrCode	output,
		@ErrMessage	output,
...
--------------------------------------------------------------------------------
CREATE PROCEDURE			[dbo].[spLocal_Util_CreateUpdateMasterBOMFormulationData_WIP]
						@ErrCode					int output,
