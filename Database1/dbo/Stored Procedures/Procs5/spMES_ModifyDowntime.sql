...
CREATE PROCEDURE dbo.spMES_ModifyDowntime
		@TransactionType Int
		,@TEDetId		Int  = Null
...
EXECUTE spMES_ModifyDowntime 1,null,'2017-03-23 20:06:01.000' ,'2017-03-23 20:08:01.000' ,1,Null,Null,Null,Null,Null,null,1,null

EXECUTE spMES_ModifyDowntime 2,232811,@StartTime ,@EndTime ,Null,Null,Null,Null,Null,Null,1,1
EXECUTE spMES_ModifyDowntime 2,232771,@StartTime,@EndTime ,Null,Null,Null,Null,Null,Null,1,1
...
-- Pass the new values to fnMES_ModifyDowntime for validation
...
IF @RecordChanged = 1
	BEGIN
		...
		IF @TransactionType = 1 AND @TEDetId IS NULL
			BEGIN
				SELECT Code = 'InvalidData', ERROR = 'Fatal - Record not Created', ErrorType = '', PropertyName1 = '', PropertyName2 = '', PropertyName3 = '', PropertyName4 = '', PropertyValue1 = '', PropertyValue2 = '', PropertyValue3 = '', PropertyValue4 = ''
				RETURN
			END
...
IF @TransactionType in (1,2)
	BEGIN
		EXECUTE  spMES_GetDowntime 1,Null,Null,null,Null,@UserId,@TEDetId,null,null,null,null,null,null
	END
