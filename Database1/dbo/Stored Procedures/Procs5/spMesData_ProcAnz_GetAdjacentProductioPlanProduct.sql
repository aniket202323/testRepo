CREATE PROCEDURE [dbo].[spMesData_ProcAnz_GetAdjacentProductioPlanProduct]
...
BEGIN
		...
		INSERT INTO @tempPPStarts
			SELECT 
				...
				,Production_Status_Id = PS.ProdStatus_Id
			...
			ORDER BY
				Unit, Start_Time
END
GRANT EXECUTE ON [dbo].[spMesData_ProcAnz_GetAdjacentProductioPlanProduct] TO [ComXClient]
