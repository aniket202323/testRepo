...
*/
CREATE procedure [dbo].[spNISI_GetPlantAppsUserPassword]
  @Username Varchar_Username, 	 --The username to retrieve the password for
 	 @Password Varchar_Username Output, --The users password, coalesced to be non-null, unless it was not found
