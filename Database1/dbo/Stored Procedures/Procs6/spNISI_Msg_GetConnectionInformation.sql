Create procedure [dbo].[spNISI_Msg_GetConnectionInformation]
AS
...
Select 'PORT' As [Name], [Value]
From Site_Parameters where Parm_Id = 6
Union
Select 'SERVERNAME' As [Name], @ServiceName
