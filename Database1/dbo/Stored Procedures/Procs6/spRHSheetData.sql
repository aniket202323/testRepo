CREATE PROCEDURE dbo.spRHSheetData 
...
Create Table #Times (
  ...
  INSERT INTO #Var
    SELECT Var_Id = av.Src_Var_Id,
           Var_Order = 10000,
           PU_Id = CASE WHEN p.Master_Unit Is Null THEN p.PU_Id ELSE p.Master_Unit END,                 
           Spec_Id = Null,
           DS_Desc = 'Alias-Src',
...
Select @GenealogyLevel = 1
  ...
  DROP TABLE #Var
  -- Return resultset [#5/5] containing the test information.
