CREATE Procedure dbo.spS88H_ParameterReport
@EventTime datetime,
@Area nvarchar(100),
@Cell nvarchar(100),
@Unit nvarchar(100),
...
Insert Into Event_Transactions (EventType, EventTimestamp, AreaName, CellName, UnitName, BatchName, UnitProcedureName, OperationName, PhaseName, PhaseInstance, ParameterName, ParameterAttributeName, ParameterAttributeValue, ParameterAttributeUOM)
  Values ('ParameterReport', @EventTime, @Area, @Cell, @Unit, @BatchId, @UnitProcedureName, @OperationName, @PhaseName, @PhaseInstance, @ParameterName,'Value', @ParameterAttributeValue, @ParameterAttributeUOM)   
