CREATE PROCEDURE dbo.spSDK_AdHocDataTypePhrases
...
BEGIN
 	 ...
 	 BEGIN
 	  	 SET 	 @ItemStart = 	 CASE 	 @FieldCode 
 	  	  	  	  	  	  	  	  	  	 WHEN 	 1 	 THEN 	 'p.Phrase_Id'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 2 	 THEN 	 'dt.Data_Type_Desc'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 3 	 THEN 	 'p.Phrase_Value'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 4 	 THEN 	 'p.Phrase_Order'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 5 	 THEN 	 'p.Comment_Required'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 6 	 THEN 	 'p.Active'
 	  	  	  	  	  	  	  	  	 END
...
SET 	 @SQL = 
'SELECT 	 DataTypePhraseId 	 = p.Phrase_Id,
 	  	  	 DataTypeName 	  	 = dt.Data_Type_Desc,
 	  	  	 PhraseName 	  	  	 = p.Phrase_Value,
 	  	  	 PhraseOrder 	  	  	 = p.Phrase_Order,
 	  	  	 CommentIsRequired 	 = p.Comment_Required,
 	  	  	 IsActive 	  	  	  	 = p.Active
 	 FROM 	 Data_Type dt
 	 JOIN 	 Phrase p 	  	  	 ON 	 p.Data_Type_Id = dt.Data_Type_Id'
EXECUTE (@SQL + @WhereClause + ' ORDER BY dt.Data_Type_Desc, p.Phrase_Order, p.Phrase_Value')
DROP TABLE #Filter
