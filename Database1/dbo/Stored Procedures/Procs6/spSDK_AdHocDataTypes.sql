CREATE PROCEDURE dbo.spSDK_AdHocDataTypes
...
BEGIN
 	 ...
 	 BEGIN
 	  	 SET 	 @ItemStart = 	 CASE 	 @FieldCode 
 	  	  	  	  	  	  	  	  	  	 WHEN 	 1 	 THEN 	 'dt.Data_Type_Id'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 2 	 THEN 	 'dt.Data_Type_Desc'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 3 	 THEN 	 'dt.User_Defined'
 	  	  	  	  	  	  	  	  	 END
 	  	 IF 	 @FieldCode IN (1,3)
 	  	 BEGIN
...
SET 	 @SQL = 
'SELECT 	 DataTypeId 	  	 = dt.Data_Type_Id,
 	  	  	 DataTypeName 	 = dt.Data_Type_Desc,
 	  	  	 IsUserDefined 	 = dt.User_Defined
 	 FROM 	 Data_Type dt'
EXECUTE (@SQL + @WhereClause + ' ORDER BY dt.Data_Type_Desc')
DROP TABLE #Filter
