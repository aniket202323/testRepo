CREATE PROCEDURE dbo.spSDK_AdHocDowntimeStatuses
 	 @sFilter 	  	  	  	  	 VARCHAR(8000)
AS
-- Begin SP
CREATE TABLE 	 #Filter 	 (
...
BEGIN
 	 ...
 	 BEGIN
 	  	 SET 	 @ItemStart = 	 CASE 	 @FieldCode 
 	  	  	  	  	  	  	  	  	  	 WHEN 	 1 	 THEN 	 'tes.TEStatus_Id'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 2 	 THEN 	 'd.Dept_Desc'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 3 	 THEN 	 'pl.PL_Desc'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 4 	 THEN 	 'pu.PU_Desc'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 5 	 THEN 	 'tes.TEStatus_Name'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 6 	 THEN 	 'tes.TEStatus_Value'
 	  	  	  	  	  	  	  	  	 END
 	  	 IF 	 @FieldCode IN (1)
 	  	 BEGIN
...
SET 	 @SQL = 
'SELECT 	 DowntimeStatusId 	  	 = tes.TEStatus_Id,
 	  	  	 DeptName 	  	  	  	  	 = d.Dept_Desc,
 	  	  	 LineName 	  	  	  	  	 = pl.PL_Desc,
 	  	  	 UnitName 	  	  	  	  	 = pu.PU_Desc,
 	  	  	 DowntimeStatusName 	 = tes.TEStatus_Name,
 	  	  	 DowntimeStatusValue 	 = tes.TEStatus_Value
 	 FROM 	  	  	 Departments d
 	 INNER JOIN 	 Prod_Lines pl 	  	  	  	 ON 	  	 d.Dept_Id = pl.Dept_Id
 	 INNER JOIN 	 Prod_Units pu 	  	  	  	 ON 	  	 pl.PL_Id = pu.PL_Id
 	 INNER JOIN 	 Timed_Event_Status tes 	 ON 	  	 pu.PU_Id = tes.PU_Id'
PRINT @SQL + @WhereClause + ' ORDER BY d.Dept_Desc ASC, pl.PL_Desc ASC, pu.PU_Order ASC, COALESCE(tes.TEStatus_Name, TEStatus_Value) ASC'
EXECUTE (@SQL + @WhereClause + ' ORDER BY d.Dept_Desc ASC, pl.PL_Desc ASC, pu.PU_Order ASC, COALESCE(tes.TEStatus_Name, TEStatus_Value) ASC')
DROP TABLE #Filter
