CREATE PROCEDURE dbo.spSDK_AdHocParameters
...
BEGIN
 	 ...
 	 BEGIN
 	  	 SET 	 @ItemStart = 	 CASE 	 @FieldCode 
 	  	  	  	  	  	  	  	  	  	 WHEN 	 1 	 THEN 	 'p.Parm_Id'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 2 	 THEN 	 'p.Parm_Name'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 3 	 THEN 	 'p.Parm_Long_Desc'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 4 	 THEN 	 'pc.Parameter_Category_Desc'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 5 	 THEN 	 'CASE WHEN p.Parm_Type_Id IN (0,1) THEN 1 ELSE 2 END'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 6 	 THEN 	 'ft.Field_Type_Desc'
 	  	  	  	  	  	  	  	  	 END
 	  	 IF 	 @FieldCode IN (1, 5)
 	  	 BEGIN
...
'SELECT 	 ParameterId 	  	  	 = 	 p.Parm_Id,
 	  	  	 ...
 	  	  	 Description 	  	  	 = 	 p.Parm_Long_Desc,
 	  	  	 Category 	  	  	  	 = 	 pc.Parameter_Category_Desc,
 	  	  	 ParameterType 	  	 = 	 CASE 	 
 	  	  	  	  	  	  	  	  	  	  	 WHEN 	 p.Parm_Type_Id IN (0,1) 	 THEN 	 1
 	  	  	  	  	  	  	  	  	  	  	 ELSE 	 2
 	  	  	  	  	  	  	  	  	  	 END,
 	  	  	 FieldType 	  	  	 = 	 ft.Field_Type_Desc
 	 FROM 	  	  	 Parameters p
...
BEGIN
 	 SET 	 @WhereClause = ' WHERE '
END
SET @WhereClause = @WhereClause + ' p.System = 0 AND 	 p.IsEncrypted = 0'
EXECUTE (@SQL + @WhereClause + ' ORDER BY p.Parm_Name')
DROP TABLE #Filter
