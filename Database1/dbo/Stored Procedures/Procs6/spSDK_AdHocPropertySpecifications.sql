CREATE PROCEDURE dbo.spSDK_AdHocPropertySpecifications
...
BEGIN
 	 ...
 	 BEGIN
 	  	 SET 	 @ItemStart = 	 CASE 	 @FieldCode 
 	  	  	  	  	  	  	  	  	  	 WHEN 	 1 	 THEN 	 'specs.AS_Id'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 2 	 THEN 	 'pp.Prop_Desc'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 3 	 THEN 	 'c.Char_Desc' 
 	  	  	  	  	  	  	  	  	  	 WHEN 	 4 	 THEN 	 's.Spec_Desc'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 5 	 THEN 	 'specs.Effective_Date'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 6 	 THEN 	 'specs.Expiration_Date'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 7 	 THEN 	 'specs.L_Entry '
 	  	  	  	  	  	  	  	  	  	 WHEN 	 8 	 THEN 	 'specs.L_Reject' 
 	  	  	  	  	  	  	  	  	  	 WHEN 	 9 	 THEN 	 'specs.L_Warning'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 10 	 THEN 	 'specs.L_User'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 11 	 THEN 	 'specs.Target'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 12 	 THEN 	 'specs.U_User'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 13 	 THEN 	 'specs.U_Warning' 
 	  	  	  	  	  	  	  	  	  	 WHEN 	 14 	 THEN 	 'specs.U_Reject'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 15 	 THEN 	 'specs.U_Entry'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 16 	 THEN 	 'specs.Test_Freq'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 17 	 THEN 	 'specs.Comment_Id' 
 	  	  	  	  	  	  	  	  	 END
 	  	 IF 	 @FieldCode IN (1,17)
 	  	 BEGIN
...
SET 	 @SQL = 
'SELECT 	 PropertySpecificationId 	 = specs.AS_Id,
 	  	  	 PropertyName 	  	  	  	 = pp.Prop_Desc,
 	  	  	 CharacteristicName 	  	 = c.Char_Desc,
 	  	  	 SpecificationName 	  	  	 = s.Spec_Desc,
 	  	  	 EffectiveDate 	  	  	  	 = specs.Effective_Date, 
 	  	  	 ExpirationDate 	  	  	  	 = specs.Expiration_Date, 
 	  	  	 URL 	  	  	  	  	  	  	 = specs.U_Reject, 
 	  	  	 UWL 	  	  	  	  	  	  	 = specs.U_Warning, 
 	  	  	 UUL 	  	  	  	  	  	  	 = specs.U_User, 
 	  	  	 TGT 	  	  	  	  	  	  	 = specs.Target, 
 	  	  	 ...
 	  	  	 LEL 	  	  	  	  	  	  	 = specs.L_Entry, 
 	  	  	 UEL 	  	  	  	  	  	  	 = specs.U_Entry, 
 	  	  	 TestingFrequency  	  	  	 = specs.Test_Freq,
 	  	  	 CommentId 	  	  	  	  	 = specs.Comment_Id
 	 FROM 	  	  	 Product_Properties pp
 	 JOIN 	  	  	 Characteristics c 	  	 ON  	 c.Prop_Id = pp.Prop_Id
