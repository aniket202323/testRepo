CREATE PROCEDURE dbo.spSDK_AdHocUsers
...
BEGIN
 	 ...
 	 BEGIN
 	  	 SET 	 @ItemStart = 	 CASE 	 @FieldCode 
 	  	  	  	  	  	  	  	  	  	 WHEN 	 1 	 THEN 	 'u.User_Id'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 2 	 THEN 	 'u.UserName'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 3 	 THEN 	 'u.User_Desc'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 4 	 THEN 	 'u.Active'
 	  	  	  	  	  	  	  	  	  	 WHEN 	 5 	 THEN 	 'u.System'
 	  	  	  	  	  	  	  	  	 END
 	  	 IF 	 @FieldCode IN (1, 5)
 	  	 BEGIN
...
BEGIN
 	 SET 	 @WhereClause = ' WHERE '
END
SET @WhereClause = @WhereClause + 'u.Is_Role = 0'
EXECUTE (@SQL + @WhereClause + ' ORDER BY u.UserName')
DROP TABLE #Filter
