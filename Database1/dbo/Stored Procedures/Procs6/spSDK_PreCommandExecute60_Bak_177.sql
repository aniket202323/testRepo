...
*/
Create Procedure [dbo].[spSDK_PreCommandExecute60_Bak_177]
...
if @UserId Is Not Null And @UserId > 0
 	  	 ...
 	  	 Exec spSDK_RegisterConnection60 @UserId
If @GetPrimaryLanguage = 1 and (@UserId Is Not Null And @UserId > 0)
 	 Begin
...
If @CommandText Is Not Null And Len(@CommandText) > 0
 	 Begin
 	  	 ...
 	  	 Exec @CommandTimeoutSeconds = spSDK_GetCommandTimeout60 @CommandText
 	 End
Else
 	 Begin
