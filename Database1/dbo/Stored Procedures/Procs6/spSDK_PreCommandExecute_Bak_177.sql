...
*/
Create Procedure [dbo].[spSDK_PreCommandExecute_Bak_177]
...
if @UserId Is Not Null And @UserId > 0
 	  	 ...
 	  	 Exec spSDK_RegisterConnection @UserId
...
If @CommandText Is Not Null And Len(@CommandText) > 0
 	 Begin
 	  	 ...
 	  	 Exec @CommandTimeoutSeconds = spSDK_GetCommandTimeout @CommandText
 	 End
Else
 	 Begin
