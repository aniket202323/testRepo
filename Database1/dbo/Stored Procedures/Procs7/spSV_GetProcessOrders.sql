CREATE  Procedure dbo.spSV_GetProcessOrders
@Sheet_Id int,
@StartTime datetime,
@EndTime datetime,
@Path_Id int = NULL,
...
-- End ECR#29497
Select A.PP_Status_Id, Process_Order, Estimated_Remaining_Date, Estimated_End_Date, PP_Id, Implied_Sequence,ISNULL(Implied_Sequence_Offset,0) Implied_Sequence_Offset, -1 * Predicted_Remaining_Duration as Predicted_Remaining_Duration, Comment_Id, A.Path_Id, PL_Id, PU_Id, Process_Order, 
...
From #ProdPlan A Join PrdExec_Path_Status_Detail B On B.Path_Id = A.Path_Id AND B.PP_Status_Id = A.PP_Status_Id
Order By 
--A.PP_Status_Id
B.Sort_Order
,
