CREATE PROCEDURE dbo.spServer_DBMgrDeleteEvent
@EventId int,
...
Select @ErrMsg = 'DeleteEvent: SPID - [' + Convert(nvarchar(10),@@SPID) + ']  EventId - [' + Convert(nVarChar(10),@EventId) + '] Start'
...
Select @ErrMsg = 'DeleteEvent: SPID - [' + Convert(nvarchar(10),@@SPID) + ']  EventId - [' + Convert(nVarChar(10),@EventId) + '] Success'
-- Execute spServer_CmnSendEmail 1,@ErrMsg,''
