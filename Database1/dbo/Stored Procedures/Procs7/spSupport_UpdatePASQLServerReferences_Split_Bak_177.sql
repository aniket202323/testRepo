CREATE Procedure [dbo].[spSupport_UpdatePASQLServerReferences_Split_Bak_177]
@OldServer varchar(255),
@NewServer varchar(255)
AS
Declare @OldServerName varchar(255)
Declare @NewServerName varchar(255)
Select @OldServerName = 'brtc-mslab0128'
Select @NewServerName = 'dev-lab8-data'
...
DECLARE @CheckSQLServername varchar(255)
 	 SELECT @CheckSQLServername = @@SERVERNAME 
