-- DESCRIPTION: spXLA_AlarmSUMM_AP is modified from spXLA_AlarmSummary_AP. Changes include additon of action-level reasons.
-- (MT/8-16-2002) and Crew,shift filters (defect #24440:mt/9-10-2002)
--
-- ECR #25128: mt/3-13-2003: handle duplicate Var_desc, which GBDB allows across entire database system.
--
CREATE PROCEDURE dbo.[spXLA_AlarmSUMM_AP_Bak_177]
 	   @Var_Id 	  	 Integer
 	 , @Var_Desc 	  	 Varchar(50)
 	 , @Start_Time 	  	 DateTime
 	 , @End_Time 	  	 DateTime
...
DECLARE @HasCrewHasShift TinyInt
 	 --Needed for product query types
...
NOCREW_NOSHIFT_ORIGINAL_INSERT:
  If @Acknowledged = 1 
    BEGIN
      INSERT INTO #TempAlarmData (  Alarm_Id, Alarm_Desc, Start_Time, End_Time, Duration, Source_Pu_Id, Prod_Id, Reason1_Id
        ...
        SELECT DISTINCT a.Alarm_Id, a.Alarm_Desc
                ...
                , [End_Time]   = Case When a.End_Time  Is NULL Then ps.End_Time
                                      ...
                                      When ps.End_Time <= a.End_Time Then ps.End_Time Else a.End_Time End
                , a.Duration, a.Source_PU_Id, ps.Prod_Id, a.Cause1, a.Cause2, a.Cause3, a.Cause4, a.Cause_Comment_Id
                , a.Max_Result, a.Min_Result, a.Start_Result, a.End_Result, a.Modified_On, a.Ack_On, a.Action1, a.Action2
                , a.Action3, a.Action4, a.Cutoff, a.User_Id, a.Research_User_Id, a.Research_Status_Id
                , a.Research_Open_Date, a.Research_Close_Date
          FROM Alarms a
...
NOCREW_NOSHIFT_APPLIED_INSERT:
  If @Acknowledged = 1  --Get only acknowledged Alarms
    INSERT INTO #TempAlarmData  (  Alarm_Id, Alarm_Desc, Start_Time, End_Time, Duration , Source_Pu_Id, Prod_Id , Applied_Prod_Id
           , Reason1_Id, Reason2_Id, Reason3_Id, Reason4_Id, Comment_Id, Max_Result, Min_Result, Start_Result, End_Result, Modified_On
           , Ack_On, A1_Id, A2_Id, A3_Id, A4_Id, Cutoff, User_Id, Research_User_Id, Research_Status_Id, Research_Open_Date, Research_Close_Date )
      SELECT DISTINCT 
             a.Alarm_Id, a.Alarm_Desc
           ...
           , [End_Time]   = Case When a.End_Time  Is NULL Then ap.End_Time
                                 ...
                                 When ap.End_Time <= a.End_Time Then ap.End_Time Else a.End_Time End
           , a.Duration , a.Source_PU_Id , ap.Prod_Id , ap.Applied_Prod_Id , a.Cause1 , a.Cause2 , a.Cause3 , a.Cause4
           , a.Cause_Comment_Id , a.Max_Result , a.Min_Result , a.Start_Result , a.End_Result , a.Modified_On , a.Ack_On
