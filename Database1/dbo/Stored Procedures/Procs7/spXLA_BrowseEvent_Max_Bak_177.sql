/* NOTE 
   ...
   ECR #24541: mt/1-15-2003:  aded fields "Conformance" and "Testing_Prct_Complete"
...
*/
-- USAGE: 
-- spXLA_BrowseEvent_Max should be called when Maximum join condition is met and no filters are specified. mt/10-3-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Max_Bak_177] 
