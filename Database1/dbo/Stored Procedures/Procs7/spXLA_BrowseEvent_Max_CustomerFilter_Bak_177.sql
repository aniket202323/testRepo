/* NOTE 
   Addd crew, shift filters: Defect #24503: mt/10-3-2002
   ...
   (3) spXLA_BrowseEvent_Max_CustomerFilter 	  	  	 'This stored Procedure
...
*/
-- USAGE: 
-- spXLA_BrowseEvent_Max_CustomerFilter should be called only when Customer_Code is specified. mt/10-3-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Max_CustomerFilter_Bak_177] 
