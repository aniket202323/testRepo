/* NOTE 
   ...
   NOT to add more branches of SQL Statement into spXLA_BrowseEvent_Max_NPT but to expand into 8 stored procedures listed 
   below. Future bug fix to core code, if any, should be done in all 8 stored procedures.  
   The 8 stored procedures are:
   (1) spXLA_BrowseEvent_Max_NPT 	  	  	  	  	 'Master copy
   (2) spXLA_BrowseEvent_Max_NPT_ShipFilter
   (3) spXLA_BrowseEvent_Max_NPT_CustomerFilter
   (4) spXLA_BrowseEvent_Max_NPT_CustomerShipFilters
   (5) spXLA_BrowseEvent_Max_NPT_PlantFilter
   (6) spXLA_BrowseEvent_Max_NPT_PlantShipFilters
   (7) spXLA_BrowseEvent_Max_NPT_PlantCustomerFilters
   (8) spXLA_BrowseEvent_Max_NPT_PlantCustomerShip
*/
-- USAGE: 
-- spXLA_BrowseEvent_Max_NPT should be called when Maximum join condition is met and no filters are specified. mt/10-3-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Max_NPT_Bak_177] 
