/* NOTE 
   ...
   (3) spXLA_BrowseEvent_Max_NPT_CustomerFilter 	  	  	 'This stored Procedure
...
*/
-- USAGE: 
-- spXLA_BrowseEvent_Max_NPT_CustomerFilter should be called only when Customer_Code is specified. mt/10-3-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Max_NPT_CustomerFilter_Bak_177] 
