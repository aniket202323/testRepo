/* NOTE 
   ...
   (4) spXLA_BrowseEvent_Max_NPT_CustomerShipFilters 	  	 'This stored Procedure
...
*/
-- USAGE: 
-- spXLA_BrowseEvent_Max_NPT_CustomerShipFilters  should be called only when two filters are specified: Customer_Code
-- & Shipment_Number filters. mt/10-3-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Max_NPT_CustomerShipFilters_Bak_177] 
