/* NOTE 
   ...
   NOT to add more branches of SQL Statement into spXLA_BrowseEvent_Max but to expand into 8 stored procedures listed 
   below. Future bug fix to core code, if any, should be done in all 8 stored procedures.  
   The 8 stored procedures are:
   (1) spXLA_BrowseEvent_Max 	  	  	  	  	 'Master copy
   (2) spXLA_BrowseEvent_Max_ShipFilter
   (3) spXLA_BrowseEvent_Max_CustomerFilter
   (4) spXLA_BrowseEvent_Max_CustomerShipFilters
   (5) spXLA_BrowseEvent_Max_NPT_PlantFilter 	  	  	 ;This stored Procedure; mt/01-20-2003
   (6) spXLA_BrowseEvent_Max_PlantShipFilters
   (7) spXLA_BrowseEvent_Max_PlantCustomerFilters
   (8) spXLA_BrowseEvent_Max_PlantCustomerShip
*/
-- USAGE: 
-- spXLA_BrowseEvent_Max_NPT_PlantFilter should be called only when Plant_Order_Number is specified; mt/10-3-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Max_NPT_PlantFilter_Bak_177] 
...
-- ORIGINAL PRODUCT FILTER ** ORIGINAL PRODUCT FILTER ** ORIGINAL PRODUCT FILTER ** ORIGINAL PRODUCT FILTER ** ORIGINAL PRODUCT FILTER ** 
-- ORIGINAL PRODUCT FILTER ** ORIGINAL PRODUCT FILTER ** ORIGINAL PRODUCT FILTER ** ORIGINAL PRODUCT FILTER ** ORIGINAL PRODUCT FILTER ** 
-- ORIGINAL PRODUCT FILTER ** ORIGINAL PRODUCT FILTER ** ORIGINAL PRODUCT FILTER ** ORIGINAL PRODUCT FILTER ** ORIGINAL PRODUCT FILTER ** 
-- ORIGINAL PRODUCT FILTER ** ORIGINAL PRODUCT FILTER ** ORIGINAL PRODUCT FILTER ** ORIGINAL PRODUCT FILTER ** ORIGINAL PRODUCT FILTER ** 
-- ORIGINAL PRODUCT FILTER ** ORIGINAL PRODUCT FILTER ** ORIGINAL PRODUCT FILTER ** ORIGINAL PRODUCT FILTER ** ORIGINAL PRODUCT FILTER ** 
    ...
    BEGIN
      If @EventStatusFilter Is NULL
        BEGIN
          INSERT INTO #Events
               SELECT e.Event_Num, e.Event_Id, e.Pu_Id, ps.Prod_Id, COALESCE(e.Start_Time, DATEADD(ss, -1, e.TimeStamp)), e.TimeStamp, e.Extended_Info, e.Event_Status, e.Applied_Product
                    , e.Conformance, e.Testing_Prct_Complete  , NULL                               --ECR #24541: mt/1-21-2003
                 FROM Events e
