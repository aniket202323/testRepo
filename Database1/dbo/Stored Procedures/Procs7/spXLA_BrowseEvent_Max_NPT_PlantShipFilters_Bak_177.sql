/* NOTE 
   ...
   (6) spXLA_BrowseEvent_Max_NPT_PlantShipFilters 	  	  	 'This stored Procedure
   (7) spXLA_BrowseEvent_Max_PlantCustomerFilters
   (8) spXLA_BrowseEvent_Max_PlantCustomerShip
*/
-- USAGE: 
-- spXLA_BrowseEvent_Max_NPT_PlantShipFilters should be called when Plant_Order_Number and Shipment_Number
-- filters are specified. mt/10-3-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Max_NPT_PlantShipFilters_Bak_177] 
