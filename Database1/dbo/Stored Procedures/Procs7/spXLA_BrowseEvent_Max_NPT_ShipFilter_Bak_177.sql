/* NOTE 
   ...
   (2) spXLA_BrowseEvent_Max_NPT_ShipFilter 	  	  	  	 'This stored Procedure
...
*/
-- USAGE: 
-- spXLA_BrowseEvent_Max_NPT_ShipFilter should be called when Shipment_Number filter is specified. mt/10-3-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Max_NPT_ShipFilter_Bak_177] 
