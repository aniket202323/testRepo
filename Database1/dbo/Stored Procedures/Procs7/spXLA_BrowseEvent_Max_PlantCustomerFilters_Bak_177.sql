/* NOTE 
   ...
   (7) spXLA_BrowseEvent_Max_PlantCustomerFilters 	  	 'This stored Procedure
   (8) spXLA_BrowseEvent_Max_PlantCustomerShip
*/
-- USAGE: 
-- spXLA_BrowseEvent_Max_PlantCustomerFilters should be called only with Customer_Code as 
-- the only filter supplied. mt/10-3-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Max_PlantCustomerFilters_Bak_177] 
