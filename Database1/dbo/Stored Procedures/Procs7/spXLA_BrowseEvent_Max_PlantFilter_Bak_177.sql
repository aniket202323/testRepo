/* NOTE 
   ...
   (5) spXLA_BrowseEvent_Max_PlantFilter 	  	  	 ;This stored Procedure; mt/01-20-2003
...
*/
-- USAGE: 
-- spXLA_BrowseEvent_Max_PlantFilter should be called only when Plant_Order_Number is specified; mt/10-3-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Max_PlantFilter_Bak_177] 
...
CREATE TABLE #Events (Event_Num Varchar(25), Event_Id Int, Pu_Id Int, Prod_Id Int, Start_Time DateTime, TimeSTamp DateTime
                    ...
                    , Event_Conformance TinyInt NULL, Testing_Prct_Complete TinyInt NULL )     --ECR #24541: mt/1-16-2003
      ...
      BEGIN
        INSERT INTO #Events
          SELECT e.Event_Num, e.Event_Id, e.Pu_Id, ps.Prod_Id, COALESCE(e.Start_Time, DATEADD(ss, -1, e.TimeStamp)), e.TimeStamp, e.Extended_Info, e.Event_Status, e.Applied_Product
               , e.Conformance, e.Testing_Prct_Complete                                        --ECR #24541: mt/1-16-2003
            FROM Events e
    ...
    BEGIN
      If @EventStatusFilter Is NULL
        BEGIN
          INSERT INTO #Events
               SELECT e.Event_Num, e.Event_Id, e.Pu_Id, ps.Prod_Id, COALESCE(e.Start_Time, DATEADD(ss, -1, e.TimeStamp)), e.TimeStamp, e.Extended_Info, e.Event_Status, e.Applied_Product
                    , e.Conformance, e.Testing_Prct_Complete                                 --ECR #24541: mt/1-21-2003
                 FROM Events e
