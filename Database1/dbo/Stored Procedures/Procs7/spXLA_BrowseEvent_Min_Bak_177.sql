/* NOTE 
   ...
   MSi/mt/1-22-2002
   MSi/mt/1-22-2002; spXLA_BrowseEvent_Min is the based stored procedure which is used when minimum join condition is met.
   ...
   The 8 stored procedures are:
    (1) spXLA_BrowseEvent_Min 	  	  	  	 'Master Copy; This stored procedure
...
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Min_Bak_177] 
