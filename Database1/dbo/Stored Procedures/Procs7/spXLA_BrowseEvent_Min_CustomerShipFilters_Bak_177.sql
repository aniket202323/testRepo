/* NOTE 
   ...
   The 8 stored procedures are:
    ...
    (4) spXLA_BrowseEvent_Min_CustomerShipFilters 	 'This stored procedure; mt/1-20-2003
...
*/
-- USAGE: 
-- spXLA_BrowseEvent_Min_CustomerShipFilters should be called only when minimum join condition is met AND 
-- Customer_Code and Shipment_Number filters are specified. mt/10-4-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Min_CustomerShipFilters_Bak_177] 
