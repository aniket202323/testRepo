/* NOTE 
   ECR #27992: mt/5-11-2004: added Customer_Order_Number & Plant_Order_Number to the return resultset since PrfXla.XLA requested this information
   ...
   The 8 stored procedures are:
    ...
    (3) spXLA_BrowseEvent_Min_NPT_CustomerFilter 	  	 'This stored procedure; mt/1-17-2003
...
*/
-- USAGE: 
-- spXLA_BrowseEvent_Min should be called only when minimum join condition is met. mt/10-3-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Min_NPT_CustomerFilter_Bak_177] 
  ...
  If @MyType = @NoStringHasStatusAsc --1
    BEGIN
        SELECT Primary_Event_Num = e.Event_Num, Event_Id = e.Event_Id, Start_Time = dbo.fnServer_CmnConvertFromDbTime(e.Start_Time,@InTimeZone), TimeStamp = dbo.fnServer_CmnConvertFromDbTime(e.TimeStamp,@InTimeZone)
             ...
             , co.Customer_Order_Number, co.Plant_Order_Number                                --ECR #27992: mt/5-11-2004
          FROM #Events e
