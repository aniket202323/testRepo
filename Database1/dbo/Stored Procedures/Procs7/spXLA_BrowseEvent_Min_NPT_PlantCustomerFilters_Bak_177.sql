/* NOTE 
   ECR #27992: mt/5-11-2004: added Customer_Order_Number and Plant_Order_Number to the return resultset since PrfXla.XLA requested this information
   ...
   The 8 stored procedures are:
    ...
    (7) spXLA_BrowseEvent_Min_NPT_PlantCustomerFilters 	 'This stored procedure; mt/1-20-2003
    (8) spXLA_BrowseEvent_Min_PlantCustomerShip
*/
-- USAGE: 
-- spXLA_BrowseEvent_Min_NPT_PlantCustomerFilters should be called only when minimum join condition is met AND 
-- Plant_Order_Number and Customer_Code filters are specified. mt/10-4-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Min_NPT_PlantCustomerFilters_Bak_177] 
