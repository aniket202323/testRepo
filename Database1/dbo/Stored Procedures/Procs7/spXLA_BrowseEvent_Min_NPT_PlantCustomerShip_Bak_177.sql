/* NOTE 
   ...
   The 8 stored procedures are:
    ...
    (8) spXLA_BrowseEvent_Min_NPT_PlantCustomerShip 	  	 'This stored procedure; mt/1-20-2003
*/
-- USAGE: 
-- spXLA_BrowseEvent_Min_NPT_PlantCustomerShip should be called only when minimum join condition is met AND 
-- Plant_Order_Number, Customer_Code, & Shipment_Number filters are specified. mt/1-20-2003
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Min_NPT_PlantCustomerShip_Bak_177] 
