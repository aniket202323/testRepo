/* NOTE 
   ECR #27992: mt/5-11-2004: added Shipment_Number to the return resultset since PrfXla.XLA requested this information users may want to see it.
   Added Crew,shift filter: Defect #24503: mt/10-3-2002
   ECR #24541: mt/1-17-2003: added fields "Conformance" and "Testing_Prct_Complete"
   ...
   MSi/mt/1-22-2002
   MSi/mt/1-17-2003; spXLA_BrowseEvent_Min is the based stored procedure which is used when minimum join condition is met.
   ...
   The 8 stored procedures are:
    ...
    (2) spXLA_BrowseEvent_Min_NPT_ShipFilter 	  	 'This stored procedure; mt/1-17-2003
    ...
    (8) spXLA_BrowseEvent_Min_PlantCustomerShip
*/
-- USAGE: 
-- spXLA_BrowseEvent_Min_NPT_ShipFilter should be called only when minimum join condition is met AND Shipment_Number
-- filter is specified. mt/1-17-2003
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Min_NPT_ShipFilter_Bak_177] 
...
CREATE TABLE #Events (Event_Num Varchar(25), Event_Id Int, Pu_Id Int, Prod_Id Int, Start_Time DateTime, TimeStamp DateTime
                    ...
                    , Event_Conformance TinyInt NULL, Testing_Prct_Complete TinyInt NULL ,NPT tinyint NULL )        --ECR #24541: mt/1-17-2003
      ...
      BEGIN
        INSERT INTO #Events
          SELECT e.Event_Num, e.Event_Id, e.Pu_Id, ps.Prod_Id, COALESCE(e.Start_Time, DATEADD(ss, -1, e.TimeStamp)), e.TimeStamp, e.Extended_Info, e.Event_Status, e.Applied_Product
               , e.Conformance, e.Testing_Prct_Complete ,NULL                                          --ECR #24541: mt/1-17-2003
            FROM Events e
  ...
  If @MyType = @NoStringHasStatusAsc --1
    BEGIN
        SELECT Primary_Event_Num = e.Event_Num, Event_Id = e.Event_Id, Start_Time = dbo.fnServer_CmnConvertFromDbTime(e.Start_Time,@InTimeZone), TimeStamp = dbo.fnServer_CmnConvertFromDbTime(e.TimeStamp,@InTimeZone)
             , e.Event_Conformance, e.Testing_Prct_Complete                                      --ECR #24541: mt/1-17-2003
             ...
             , sh.Shipment_Number                                                                --ECR #27992: mt/5-11-2004
          FROM #Events e
