/* NOTE 
   ...
   The 8 stored procedures are:
    ...
    (7) spXLA_BrowseEvent_Min_PlantCustomerFilters 	 'This stored procedure; mt/1-20-2003
    (8) spXLA_BrowseEvent_Min_PlantCustomerShip
*/
-- USAGE: 
-- spXLA_BrowseEvent_Min_PlantCustomerFilters should be called only when minimum join condition is met AND 
-- Plant_Order_Number and Customer_Code filters are specified. mt/10-4-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Min_PlantCustomerFilters_Bak_177] 
