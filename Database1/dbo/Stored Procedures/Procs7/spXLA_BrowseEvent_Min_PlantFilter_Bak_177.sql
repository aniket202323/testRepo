/* NOTE 
   ...
   The 8 stored procedures are:
    ...
    (5) spXLA_BrowseEvent_Min_PlantFilter 	  	 'This stored procedure; mt/1-20-2003
...
*/
-- USAGE: 
-- spXLA_BrowseEvent_Min_PlantFilter should be called only when minimum join condition is met AND Plant_Order_Number
-- filter is specified. mt/10-3-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Min_PlantFilter_Bak_177] 
