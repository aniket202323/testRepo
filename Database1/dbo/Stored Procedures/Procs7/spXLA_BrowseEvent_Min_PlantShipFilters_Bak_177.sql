/* NOTE 
   ...
   The 8 stored procedures are:
    ...
    (6) spXLA_BrowseEvent_Min_PlantShipFilters 	  	 'This stored procedure mt/1-20-2003
    (7) spXLA_BrowseEvent_Min_PlantCustomerFilters
    (8) spXLA_BrowseEvent_Min_PlantCustomerShip
*/
-- USAGE: 
-- spXLA_BrowseEvent_Min_PlantShipFilters should be called only when minimum join condition is met AND 
-- Plant_Order_Number and Shipment_Number Filters are specified. mt/1-20-2003
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Min_PlantShipFilters_Bak_177] 
...
If @Start_Time Is NULL 	 SELECT @Start_Time = '1-jan-1970'
