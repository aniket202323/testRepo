/* NOTE 
   ...
   The 8 stored procedures are:
    ...
    (2) spXLA_BrowseEvent_Min_ShipFilter 	  	 'This stored procedure; mt/1-17-2003
...
*/
-- USAGE: 
-- spXLA_BrowseEvent_Min_ShipFilter should be called only when minimum join condition is met AND Shipment_Number
-- filter is specified. mt/1-17-2003
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Min_ShipFilter_Bak_177] 
...
CREATE TABLE #Events (Event_Num Varchar(25), Event_Id Int, Pu_Id Int, Prod_Id Int, Start_Time DateTime, TimeStamp DateTime
                    ...
                    , Event_Conformance TinyInt NULL, Testing_Prct_Complete TinyInt NULL )        --ECR #24541: mt/1-17-2003
      ...
      BEGIN
        INSERT INTO #Events
          SELECT e.Event_Num, e.Event_Id, e.Pu_Id, ps.Prod_Id, COALESCE(e.Start_Time, DATEADD(ss, -1, e.TimeStamp)), e.TimeStamp, e.Extended_Info, e.Event_Status, e.Applied_Product
               , e.Conformance, e.Testing_Prct_Complete                                           --ECR #24541: mt/1-17-2003
            FROM Events e
