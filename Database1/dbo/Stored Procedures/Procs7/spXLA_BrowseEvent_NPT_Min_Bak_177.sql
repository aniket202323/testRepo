/* NOTE 
   Added Crew, shift filters: Defect #24503: mt/10-3-2002
   ECR #24541: mt/1-16-2003: added fields "Conformance" and "Testing_Prct_Complete"
   ...
   MSi/mt/1-22-2002
   MSi/mt/1-22-2002; spXLA_BrowseEvent_NPT_Min is the based stored procedure which is used when minimum join condition is met.
   ...
   We chose NOT to add more branches of SQL Statements to spXLA_BrowseEvent_NPT_Min, but rather to expand 
   ...
   The 8 stored procedures are:
    (1) spXLA_BrowseEvent_NPT_Min 	  	  	  	 'Master Copy; This stored procedure
    (2) spXLA_BrowseEvent_NPT_Min_ShipmentFilter
    (3) spXLA_BrowseEvent_NPT_Min_CustomerFilter
    (4) spXLA_BrowseEvent_NPT_Min_CustomerShipFilters
    (5) spXLA_BrowseEvent_NPT_Min_PlantFilter
    (6) spXLA_BrowseEvent_NPT_Min_PlantShipFilters
    (7) spXLA_BrowseEvent_NPT_Min_PlantCustomerFilters
    (8) spXLA_BrowseEvent_NPT_Min_PlantCustomerShip
*/
-- USAGE: 
-- spXLA_BrowseEvent_NPT_Min should be called only when minimum join condition is met. mt/10-3-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_NPT_Min_Bak_177] 
...
CREATE TABLE #Events (Event_Num Varchar(25), Event_Id Int, Pu_Id Int, Prod_Id Int, Start_Time DateTime, TimeStamp DateTime
                    , Extended_Info Varchar(255) NULL, Event_Status Int NULL, Applied_Product Int NULL --)
                    , Event_Conformance TinyInt NULL, Testing_Prct_Complete TinyInt NULL ,NPT tinyint NULL) --ECR #24541: mt/1-16-2003
      ...
      BEGIN
        INSERT INTO #Events
          SELECT e.Event_Num, e.Event_Id, e.Pu_Id, ps.Prod_Id, COALESCE(e.Start_Time, DATEADD(ss, -1, e.TimeStamp)), e.TimeStamp, e.Extended_Info, e.Event_Status, e.Applied_Product
               , e.Conformance, e.Testing_Prct_Complete , NULL                                       --ECR #24541: mt/1-16-2003
            FROM Events e
      ...
      If @EventStatusFilter Is NULL
        BEGIN
          INSERT INTO #Events
            ...
            UNION
               SELECT e.Event_Num, e.Event_Id, e.Pu_Id, ps.Prod_Id, e.Start_Time, e.TimeStamp, e.Extended_Info, e.Event_Status, e.Applied_Product
                    , e.Conformance, e.Testing_Prct_Complete , NULL                                  --ECR #24541: mt/1-16-2003
                 FROM Events e
...
UPDATE #Events SET Start_Time = n.Endtime,
 	  	  	  	  	 NPT = 1
FROM #Events  JOIN @Periods_NPT1 n ON (Start_Time > n.StartTime AND TimeStamp > n.EndTime AND Start_Time < n.EndTime)
-- Case 2 :  Downtime    St---------------------End
-- 	  	  	  NPT 	  	  	  	  	 St--------------End
UPDATE #Events SET TimeStamp = n.Starttime,
 	  	  	  	    NPT = 1
...
-- 	  	  	  NPT 	  	    St-----------------End
UPDATE #Events  SET NPT = 1
FROM #Events  JOIN @Periods_NPT1 n ON( (n.StartTime BETWEEN Start_Time AND TimeStamp) AND (n.Endtime BETWEEN Start_Time AND TimeStamp))  
  ...
  If @MyType = @NoStringHasStatusAsc --1
    BEGIN
        SELECT Primary_Event_Num = e.Event_Num, Event_Id = e.Event_Id, Start_Time = dbo.fnServer_CmnConvertFromDbTime(e.Start_Time,@InTimeZone), TimeStamp = dbo.fnServer_CmnConvertFromDbTime(e.TimeStamp,@InTimeZone)
             , e.Event_Conformance, e.Testing_Prct_Complete                                   --ECR #24541: mt/1-16-2003
