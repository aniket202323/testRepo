/* NOTE ON spXLA_BrowseEvent_NoProduct
   ...
   (1) spXLA_BrowseEvent_NoProduct 	  	  	  	  	 'Master copy; This stored Procedure
   (2) spXLA_BrowseEvent_NoProduct_ShipFilter
   (3) spXLA_BrowseEvent_NoProduct_CustomerFilter
...
*/
-- USAGE: 
-- spXLA_BrowseEvent_NoProduct should be called when no-product join condition is met and no filters are specified.
--
CREATE PROCEDURE dbo.spXLA_BrowseEvent_NoProduct 
...
CREATE TABLE #Events (
          ...
          , Event_Conformance TinyInt NULL, Testing_Prct_Complete TinyInt NULL
 	  	   ,CONSTRAINT [TempEvents_PK_EventId] PRIMARY KEY NONCLUSTERED (Event_Id asc))
      ...
      BEGIN
        INSERT INTO #Events
          SELECT e.Event_Num, e.Event_Id, e.Pu_Id, COALESCE(e.Start_Time, DATEADD(ss, -1, e.TimeStamp)), e.TimeStamp, e.Extended_Info, e.Event_Status
               , e.Conformance, e.Testing_Prct_Complete                                             --defect #24541:mt/1-14-2003
            FROM Events e
