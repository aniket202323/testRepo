/* NOTE  
   ...
   (3) spXLA_BrowseEvent_NoProduct_CustomerFilter 	  	 'This stored Procedure
...
*/
-- USAGE: 
-- spXLA_BrowseEvent_NoProduct_CustomerFilter should be called when no-product join condition is met and 
-- Customer_Code filter is specified. MSi/mt/9-30-20002
--
CREATE PROCEDURE dbo.spXLA_BrowseEvent_NoProduct_CustomerFilter 
