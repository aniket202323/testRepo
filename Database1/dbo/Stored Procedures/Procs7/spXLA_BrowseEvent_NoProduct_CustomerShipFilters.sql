/* NOTE: 
   ...
   #ECR #24541:mt/1-15-2003: added fields "Conformance" & "Testing_Prct_Complete"
   Originally (spXLASearchEvent_ series), we divide stored procedures into 5 groups based on the need for joins to obtain the required attributes for
   ...
   (4) spXLA_BrowseEvent_NoProduct_CustomerShipFilters 	 'This stored Procedure
...
*/
-- USAGE: 
-- spXLA_BrowseEvent_NoProduct_CustomerShipFilters should be called when no-product join condition is met and 
-- Customer_Code and Shipment_Number filters are specified. MSi/mt/10-1-2002
--
CREATE PROCEDURE dbo.spXLA_BrowseEvent_NoProduct_CustomerShipFilters 
 	 ...
 	 , @Shipment_Number 	 Varchar(50) 	 -- Filter ALSO By Shipment_Number MSi/mt/12-05-2001
...
-- ORDER_AND_SHIPMENT_RESULTSET ORDER_AND_SHIPMENT_RESULTSET ORDER_AND_SHIPMENT_RESULTSET ORDER_AND_SHIPMENT_RESULTSET 
-- ORDER_AND_SHIPMENT_RESULTSET ORDER_AND_SHIPMENT_RESULTSET ORDER_AND_SHIPMENT_RESULTSET ORDER_AND_SHIPMENT_RESULTSET 
-- ORDER_AND_SHIPMENT_RESULTSET ORDER_AND_SHIPMENT_RESULTSET ORDER_AND_SHIPMENT_RESULTSET ORDER_AND_SHIPMENT_RESULTSET 
-- ORDER_AND_SHIPMENT_RESULTSET ORDER_AND_SHIPMENT_RESULTSET ORDER_AND_SHIPMENT_RESULTSET ORDER_AND_SHIPMENT_RESULTSET 
-- ORDER_AND_SHIPMENT_RESULTSET ORDER_AND_SHIPMENT_RESULTSET ORDER_AND_SHIPMENT_RESULTSET ORDER_AND_SHIPMENT_RESULTSET 
