/* NOTE ON spXLA_BrowseEvent_NoProduct_NPT
   Defect #24541:added more fields (Conformance & Testing_Prct_Complete) to return recordset:mt/1-14-2003
   Defect #24503:added crew, shift filter:mt/9-26-2002
   ...
   NOT to add more branches of SQL Statement into spXLA_BrowseEvent_NoProduct_NPT but to expand into 8 stored procedures listed 
   below. Future bug fix to core code, if any, should be done in all 8 stored procedures.  
   The 8 stored procedures are:
   (1) spXLA_BrowseEvent_NoProduct_NPT 	  	  	  	  	 'Master copy; This stored Procedure
   (2) spXLA_BrowseEvent_NoProduct_NPT_ShipFilter
   (3) spXLA_BrowseEvent_NoProduct_NPT_CustomerFilter
   (4) spXLA_BrowseEvent_NoProduct_NPT_CustomerShipFilters
   (5) spXLA_BrowseEvent_NoProduct_NPT_PlantFilter
   (6) spXLA_BrowseEvent_NoProduct_NPT_PlantShipFilters
   (7) spXLA_BrowseEvent_NoProduct_NPT_PlantCustomerFilters
   (8) spXLA_BrowseEvent_NoProduct_NPT_PlantCustomerShip
*/
-- USAGE: 
-- spXLA_BrowseEvent_NoProduct_NPT should be called when no-product join condition is met and no filters are specified.
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_NoProduct_NPT_Bak_177] 
...
CREATE TABLE #Events (
            Event_Num Varchar(25), Event_Id Int, Pu_Id Int, Start_Time DateTime, TimeStamp DateTime   
          , Extended_Info Varchar(255) NULL, Event_Status Int NULL
          , Event_Conformance TinyInt NULL, Testing_Prct_Complete TinyInt NULL,NPT tinyint NULL)
      ...
      BEGIN
        INSERT INTO #Events
          SELECT e.Event_Num, e.Event_Id, e.Pu_Id, COALESCE(e.Start_Time, DATEADD(ss, -1, e.TimeStamp)), e.TimeStamp, e.Extended_Info, e.Event_Status
               , e.Conformance, e.Testing_Prct_Complete ,NULL                                            --defect #24541:mt/1-14-2003
            FROM Events e
...
Else If @ShowOrderInfo = 1 AND @ShowShipmentInfo = 0  GOTO ORDER_INFO_RESULTSET
Else If @ShowOrderInfo = 0 AND @ShowShipmentInfo = 0  GOTO BASIC_INFO_RESULTSET
--EndIf
--/*
-- 	  	 Non Productive Time
-- 	  	 TODO: Copy the below lines to a new sp so that we can just call that new sp
...
--SELECT * FROM #Events 
-- BASIC_INFO_RESULTSET BASIC_INFO_RESULTSET BASIC_INFO_RESULTSET BASIC_INFO_RESULTSET BASIC_INFO_RESULTSET BASIC_INFO_RESULTSET 
BASIC_INFO_RESULTSET:
  ...
  If @MyType = @NoStringHasStatusAsc --1
    BEGIN
        SELECT Primary_Event_Num = e.Event_Num, Event_Id = e.Event_Id, Start_Time = dbo.fnServer_CmnConvertFromDbTime(e.Start_Time,@InTimeZone), TimeStamp = dbo.fnServer_CmnConvertFromDbTime(e.TimeStamp,@InTimeZone)
             , e.Event_Conformance, e.Testing_Prct_Complete                                      --ECR #24541:mt/1-14-2003
  ...
  Else If @MyType = @HasStringHasStatusAsc --3
    BEGIN
        SELECT Primary_Event_Num = e.Event_Num, Event_Id = e.Event_Id, Start_Time = dbo.fnServer_CmnConvertFromDbTime(e.Start_Time,@InTimeZone), TimeStamp = dbo.fnServer_CmnConvertFromDbTime(e.TimeStamp,@InTimeZone)
          ...
          LEFT OUTER JOIN Event_Details ed ON ed.Event_Id = e.Event_Id
          LEFT OUTER JOIN Production_Status s ON s.ProdStatus_Id = e.Event_Status
         WHERE e.Event_Num Like '%' + ltrim(rtrim(@SearchString)) + '%' AND e.NPT IS NULL
      ORDER BY e.TimeStamp ASC, e.Event_Num
    END
  ...
  If @MyType = @NoStringHasStatusAsc --1
    BEGIN
        SELECT Primary_Event_Num = e.Event_Num, Event_Id = e.Event_Id, Start_Time = dbo.fnServer_CmnConvertFromDbTime(e.Start_Time,@InTimeZone), TimeStamp = dbo.fnServer_CmnConvertFromDbTime(e.TimeStamp,@InTimeZone)
             ...
             , ed.Initial_Dimension_A, ed.Initial_Dimension_X, ed.Initial_Dimension_Y, ed.Initial_Dimension_Z
             , ed.Final_Dimension_A, ed.Final_Dimension_X, ed.Final_Dimension_Y, ed.Final_Dimension_Z
             , ed.Orientation_X, ed.Orientation_Y, ed.Orientation_Z, e.Extended_Info, C.Crew_Desc, C.Shift_Desc
          FROM #Events e
          JOIN Crew_Schedule C ON C.Pu_Id = e.Pu_Id AND C.Crew_Desc = @Crew_Desc AND e.TimeStamp BETWEEN C.Start_Time AND C.End_Time
          JOIN Prod_Units pu ON pu.Pu_Id = e.Pu_Id
          LEFT OUTER JOIN Event_Details ed ON ed.Event_Id = e.Event_Id
          LEFT OUTER JOIN Production_Status s ON s.ProdStatus_Id = e.Event_Status
 	  	   WHERE e.NPT IS NULL 	 
  ...
  If @MyType = @NoStringHasStatusAsc --1
    BEGIN
        SELECT Primary_Event_Num = e.Event_Num, Event_Id = e.Event_Id, Start_Time = dbo.fnServer_CmnConvertFromDbTime(e.Start_Time,@InTimeZone), TimeStamp = dbo.fnServer_CmnConvertFromDbTime(e.TimeStamp,@InTimeZone)
             ...
             , ed.Orientation_X, ed.Orientation_Y, ed.Orientation_Z, e.Extended_Info, C.Crew_Desc, C.Shift_Desc
          FROM #Events e
          JOIN Crew_Schedule C ON C.Pu_Id = e.Pu_Id AND C.Shift_Desc = @Shift_Desc AND e.TimeStamp BETWEEN C.Start_Time AND C.End_Time
          JOIN Prod_Units pu ON pu.Pu_Id = e.Pu_Id
          LEFT OUTER JOIN Event_Details ed ON ed.Event_Id = e.Event_Id
          LEFT OUTER JOIN Production_Status s ON s.ProdStatus_Id = e.Event_Status
 	  	   WHERE e.NPT IS NULL 	 
  ...
  If @MyType = @NoStringHasStatusAsc --1
    BEGIN
        SELECT Primary_Event_Num = e.Event_Num, Event_Id = e.Event_Id, Start_Time = dbo.fnServer_CmnConvertFromDbTime(e.Start_Time,@InTimeZone), TimeStamp = dbo.fnServer_CmnConvertFromDbTime(e.TimeStamp,@InTimeZone)
             ...
             , ed.Orientation_X, ed.Orientation_Y, ed.Orientation_Z, e.Extended_Info, C.Crew_Desc, C.Shift_Desc
          FROM #Events e
          JOIN Crew_Schedule C ON C.Pu_Id = e.Pu_Id AND C.Crew_Desc = @Crew_Desc AND C.Shift_Desc = @Shift_Desc AND e.TimeStamp BETWEEN C.Start_Time AND C.End_Time
          JOIN Prod_Units pu ON pu.Pu_Id = e.Pu_Id
          LEFT OUTER JOIN Event_Details ed ON ed.Event_Id = e.Event_Id
          LEFT OUTER JOIN Production_Status s ON s.ProdStatus_Id = e.Event_Status
 	  	   WHERE e.NPT IS NULL 	 
...
--  ORDER_INFO_RESULTSET ORDER_INFO_RESULTSET ORDER_INFO_RESULTSET ORDER_INFO_RESULTSET ORDER_INFO_RESULTSET ORDER_INFO_RESULTSET ORDER_INFO_RESULTSET ORDER_INFO_RESULTSET
ORDER_INFO_RESULTSET:
  --SET NOCOUNT OFF --commented out because ECR #26008 (mt/8-25-2003)
  ...
  If @MyType = @NoStringHasStatusAsc --1
    BEGIN
        SELECT Primary_Event_Num = e.Event_Num, Event_Id = e.Event_Id, Start_Time = dbo.fnServer_CmnConvertFromDbTime(e.Start_Time,@InTimeZone), TimeStamp = dbo.fnServer_CmnConvertFromDbTime(e.TimeStamp,@InTimeZone)
          ...
          LEFT OUTER JOIN  Customer_Orders co ON co.Order_Id = l.Order_Id 
          LEFT OUTER JOIN Production_Status s ON s.ProdStatus_Id = e.Event_Status
 	  	   WHERE e.NPT IS NULL 	 
      ORDER BY e.TimeStamp ASC, e.Event_Num
    END
  ...
  If @MyType = @NoStringHasStatusAsc --1
    BEGIN
        SELECT Primary_Event_Num = e.Event_Num, Event_Id = e.Event_Id, Start_Time = dbo.fnServer_CmnConvertFromDbTime(e.Start_Time,@InTimeZone), TimeStamp = dbo.fnServer_CmnConvertFromDbTime(e.TimeStamp,@InTimeZone)
             ...
             , ed.Final_Dimension_A, ed.Final_Dimension_X, ed.Final_Dimension_Y, ed.Final_Dimension_Z
             , ed.Orientation_X, ed.Orientation_Y, ed.Orientation_Z
             , co.Customer_Order_Number, co.Plant_Order_Number, e.Extended_Info, C.Crew_Desc, C.Shift_Desc
          FROM #Events e
          JOIN Crew_Schedule C ON C.Pu_Id = e.Pu_Id AND C.Crew_Desc = @Crew_Desc AND e.TimeStamp BETWEEN C.Start_Time AND C.End_Time
          JOIN Prod_Units pu ON pu.Pu_Id = e.Pu_Id
          LEFT OUTER JOIN Event_Details ed ON ed.Event_Id = e.Event_Id  
  ...
  If @MyType = @NoStringHasStatusAsc --1
    BEGIN
        SELECT Primary_Event_Num = e.Event_Num, Event_Id = e.Event_Id, Start_Time = dbo.fnServer_CmnConvertFromDbTime(e.Start_Time,@InTimeZone), TimeStamp = dbo.fnServer_CmnConvertFromDbTime(e.TimeStamp,@InTimeZone)
             ...
             , ed.Initial_Dimension_A, ed.Initial_Dimension_X, ed.Initial_Dimension_Y, ed.Initial_Dimension_Z
             , ed.Final_Dimension_A, ed.Final_Dimension_X, ed.Final_Dimension_Y, ed.Final_Dimension_Z
             , ed.Orientation_X, ed.Orientation_Y, ed.Orientation_Z, sh.Shipment_Number, e.Extended_Info, C.Crew_Desc, C.Shift_Desc
          FROM #Events e
          JOIN Crew_Schedule C ON C.Pu_Id = e.Pu_Id AND C.Crew_Desc = @Crew_Desc AND e.TimeStamp BETWEEN C.Start_Time AND C.End_Time
          JOIN Prod_Units pu ON pu.Pu_Id = e.Pu_Id
          LEFT OUTER JOIN Event_Details ed ON ed.Event_Id = e.Event_Id  
  ...
  If @MyType = @NoStringHasStatusAsc --1
    BEGIN
        SELECT Primary_Event_Num = e.Event_Num, Event_Id = e.Event_Id, Start_Time = dbo.fnServer_CmnConvertFromDbTime(e.Start_Time,@InTimeZone), TimeStamp = dbo.fnServer_CmnConvertFromDbTime(e.TimeStamp,@InTimeZone)
             ...
             , ed.Final_Dimension_A, ed.Final_Dimension_X, ed.Final_Dimension_Y, ed.Final_Dimension_Z
             , ed.Orientation_X, ed.Orientation_Y, ed.Orientation_Z
             , co.Customer_Order_Number, co.Plant_Order_Number, sh.Shipment_Number, e.Extended_Info, C.Crew_Desc, C.Shift_Desc
          FROM #Events e
          JOIN Crew_Schedule C ON C.Pu_Id = e.Pu_Id AND C.Crew_Desc = @Crew_Desc AND e.TimeStamp BETWEEN C.Start_Time AND C.End_Time
          JOIN Prod_Units pu ON pu.Pu_Id = e.Pu_Id
          LEFT OUTER JOIN Event_Details ed ON ed.Event_Id = e.Event_Id  
...
WHERE e.NPT IS NULL
  ...
  --EndIf @MyType 
  GOTO DROP_TEMP_TABLES
--End HASCREW_NOSHIFT_ORDER_AND_SHIPMENT_INFO_RESULTSE:
