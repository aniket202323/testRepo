/* NOTE: 
   ...
   (4) spXLA_BrowseEvent_NoProduct_NPT_CustomerShipFilters 	 'This stored Procedure
...
*/
-- USAGE: 
-- spXLA_BrowseEvent_NoProduct_NPT_CustomerShipFilters should be called when no-product join condition is met and 
-- Customer_Code and Shipment_Number filters are specified. MSi/mt/10-1-2002
--
CREATE PROCEDURE dbo.spXLA_BrowseEvent_NoProduct_NPT_CustomerShipFilters 
