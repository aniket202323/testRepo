/* NOTE 
   ...
   (7) spXLA_BrowseEvent_NoProduct_NPT_PlantCustomerFilters 	  	 'This stored Procedure
   (8) spXLASearchEvent_NoProduct_PlantCustomerShip
*/
-- USAGE: 
-- spXLA_BrowseEvent_NoProduct_NPT_PlantCustomerFilters should be called when no-product join condition is met and 
-- Plant_Order_Number and Customer_Code filters are specified. MSi/mt/10-1-2002
--
CREATE PROCEDURE dbo.spXLA_BrowseEvent_NoProduct_NPT_PlantCustomerFilters 
