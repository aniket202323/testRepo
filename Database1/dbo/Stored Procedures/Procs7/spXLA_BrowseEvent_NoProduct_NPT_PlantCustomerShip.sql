/* NOTE 
   ...
   (8) spXLA_BrowseEvent_NoProduct_NPT_PlantCustomerShip 	  	 'This stored Procedure
*/
-- USAGE: 
-- spXLA_BrowseEvent_NoProduct_NPT_PlantCustomerShip should be called when no-product join condition is met and 
-- Plant_Order_Number, Customer_Code, and Shipment_Number filters are specified. MSi/mt/10-1-2002
--
CREATE PROCEDURE dbo.spXLA_BrowseEvent_NoProduct_NPT_PlantCustomerShip 
