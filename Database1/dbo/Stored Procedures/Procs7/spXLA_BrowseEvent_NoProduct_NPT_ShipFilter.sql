/* NOTE 
   ...
   (2) spXLA_BrowseEvent_NoProduct_NPT_ShipFilter 	  	  	 'This stored Procedure
...
*/
-- USAGE: 
-- spXLA_BrowseEvent_NoProduct_NPT_ShipFilter should be called when no-product join condition is met and 
-- Shipment_Number filter is specified.  MSi/mt/10-1-2002
--
CREATE PROCEDURE dbo.spXLA_BrowseEvent_NoProduct_NPT_ShipFilter 
...
CREATE TABLE #Events (Event_Num Varchar(50), Event_Id Int, Pu_Id Int, Start_Time DateTime, TimeStamp DateTime
                    ...
                    , Event_Conformance TinyInt NULL, Testing_Prct_Complete TinyInt NULL,NPT tinyint NULL) --ECR #24541:mt/1-15-2003:added Conformance & Testing_Prct_Complete
