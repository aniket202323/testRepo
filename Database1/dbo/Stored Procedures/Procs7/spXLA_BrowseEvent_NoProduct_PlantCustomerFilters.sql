/* NOTE 
   ...
   (2) spXLASearchEvent_NoProduct_ShipFilter
   (3) spXLASearchEvent_NoProduct_CustomerFilter
   (4) spXLASearchEvent_NoProduct_CustomerShipFilters
   (5) spXLASearchEvent_NoProduct_PlantFilter
   (6) spXLASearchEvent_NoProduct_PlantShipFilters
   (7) spXLA_BrowseEvent_NoProduct_PlantCustomerFilters 	  	 'This stored Procedure
   (8) spXLASearchEvent_NoProduct_PlantCustomerShip
*/
-- USAGE: 
-- spXLA_BrowseEvent_NoProduct_PlantCustomerFilters should be called when no-product join condition is met and 
-- Plant_Order_Number and Customer_Code filters are specified. MSi/mt/10-1-2002
--
CREATE PROCEDURE dbo.spXLA_BrowseEvent_NoProduct_PlantCustomerFilters 
...
--  ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET
--  ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET
--  ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET
--  ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET
--  ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET ORDER_RESULTSET
