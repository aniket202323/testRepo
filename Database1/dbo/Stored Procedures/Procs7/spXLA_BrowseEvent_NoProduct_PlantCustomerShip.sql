/* NOTE 
   Added Crew,Shift Filter: Defect #24503: mt/10-1-2002
   ECR #24541:mt/1-15-2003:  added fields "Conformance" and "Testing_Prct_Complete"
   Originally (in the spXLASearchEvent_ ... series), we divide stored procedures into 5 groups based on the need for joins to obtain the required attributes for
   ...
   (8) spXLA_BrowseEvent_NoProduct_PlantCustomerShip 	  	 'This stored Procedure
*/
-- USAGE: 
-- spXLA_BrowseEvent_NoProduct_PlantCustomerShip should be called when no-product join condition is met and 
-- Plant_Order_Number, Customer_Code, and Shipment_Number filters are specified. MSi/mt/10-1-2002
--
CREATE PROCEDURE dbo.spXLA_BrowseEvent_NoProduct_PlantCustomerShip 
 	 ...
 	 , @Plant_Order_Number 	 Varchar(50) 	 -- Filter By Plant_Order_Number
...
CREATE TABLE #Events (Event_Num Varchar(50), Event_Id Int, Pu_Id Int, Start_Time DateTime, TimeStamp DateTime
                    , Extended_Info Varchar(255) NULL, Event_Status Int NULL --)
                    , Event_Conformance TinyInt NULL, Testing_Prct_Complete TinyInt NULL ) --ECR#24541:mt/1-15-2003
      ...
      BEGIN
        INSERT INTO #Events
          SELECT e.Event_Num, e.Event_Id, e.Pu_Id, COALESCE(e.Start_Time, DATEADD(ss, -1, e.TimeStamp)), e.TimeStamp, e.Extended_Info, e.Event_Status
               , e.Conformance, e.Testing_Prct_Complete                                    --ECR #24541:mt/1-15-2003
            FROM Events e
...
If      @ShowOrderInfo = 1 AND @ShowShipmentInfo = 1  GOTO ORDER_AND_SHIPMENT_RESULT_SET
Else If @ShowOrderInfo = 0 AND @ShowShipmentInfo = 1  GOTO SHIPMENT_RESULT_SET
Else If @ShowOrderInfo = 1 AND @ShowShipmentInfo = 0  GOTO ORDER_RESULT_SET
Else If @ShowOrderInfo = 0 AND @ShowShipmentInfo = 0  GOTO BASIC_EVENT_INFO_RESULT_SET
--EndIf
-- BASIC_EVENT_INFO_RESULT_SET BASIC_EVENT_INFO_RESULT_SET BASIC_EVENT_INFO_RESULT_SET BASIC_EVENT_INFO_RESULT_SET BASIC_EVENT_INFO_RESULT_SET
-- BASIC_EVENT_INFO_RESULT_SET BASIC_EVENT_INFO_RESULT_SET BASIC_EVENT_INFO_RESULT_SET BASIC_EVENT_INFO_RESULT_SET BASIC_EVENT_INFO_RESULT_SET
-- BASIC_EVENT_INFO_RESULT_SET BASIC_EVENT_INFO_RESULT_SET BASIC_EVENT_INFO_RESULT_SET BASIC_EVENT_INFO_RESULT_SET BASIC_EVENT_INFO_RESULT_SET
-- BASIC_EVENT_INFO_RESULT_SET BASIC_EVENT_INFO_RESULT_SET BASIC_EVENT_INFO_RESULT_SET BASIC_EVENT_INFO_RESULT_SET BASIC_EVENT_INFO_RESULT_SET
-- BASIC_EVENT_INFO_RESULT_SET BASIC_EVENT_INFO_RESULT_SET BASIC_EVENT_INFO_RESULT_SET BASIC_EVENT_INFO_RESULT_SET BASIC_EVENT_INFO_RESULT_SET
...
--  ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET
--  ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET
--  ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET
--  ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET
--  ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET ORDER_RESULT_SET
...
-- SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET
-- SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET
-- SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET
-- SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET
-- SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET SHIPMENT_RESULT_SET
...
-- ORDER_AND_SHIPMENT_RESULT_SET ORDER_AND_SHIPMENT_RESULT_SET ORDER_AND_SHIPMENT_RESULT_SET ORDER_AND_SHIPMENT_RESULT_SET ORDER_AND_SHIPMENT_RESULT_SET
-- ORDER_AND_SHIPMENT_RESULT_SET ORDER_AND_SHIPMENT_RESULT_SET ORDER_AND_SHIPMENT_RESULT_SET ORDER_AND_SHIPMENT_RESULT_SET ORDER_AND_SHIPMENT_RESULT_SET
-- ORDER_AND_SHIPMENT_RESULT_SET ORDER_AND_SHIPMENT_RESULT_SET ORDER_AND_SHIPMENT_RESULT_SET ORDER_AND_SHIPMENT_RESULT_SET ORDER_AND_SHIPMENT_RESULT_SET
-- ORDER_AND_SHIPMENT_RESULT_SET ORDER_AND_SHIPMENT_RESULT_SET ORDER_AND_SHIPMENT_RESULT_SET ORDER_AND_SHIPMENT_RESULT_SET ORDER_AND_SHIPMENT_RESULT_SET
-- ORDER_AND_SHIPMENT_RESULT_SET ORDER_AND_SHIPMENT_RESULT_SET ORDER_AND_SHIPMENT_RESULT_SET ORDER_AND_SHIPMENT_RESULT_SET ORDER_AND_SHIPMENT_RESULT_SET
