/* NOTE 
   ...
   (5) spXLA_BrowseEvent_NoProduct_PlantFilter 	  	  	 'This stored Procedure
...
*/
-- USAGE: 
-- spXLA_BrowseEvent_NoProduct_PlantFilter should be called when no-product join condition is met and 
-- Plant_Order_Number is specified. MSi/mt/9-30-2002
--
CREATE PROCEDURE dbo.spXLA_BrowseEvent_NoProduct_PlantFilter 
