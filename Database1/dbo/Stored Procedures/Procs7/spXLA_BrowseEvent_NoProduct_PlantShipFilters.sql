/* NOTE Added Crew,Shift Filter: Defect #24503: mt/10-1-2002 
   ...
   (6) spXLA_BrowseEvent_NoProduct_PlantShipFilters 	  	 'This stored Procedure
   (7) spXLASearchEvent_NoProduct_PlantCustomerFilters
   (8) spXLASearchEvent_NoProduct_PlantCustomerShip
*/
-- USAGE: 
-- spXLA_BrowseEvent_NoProduct_PlantShipFilters should be called when no-product join condition is met and 
-- Plant_Order_Number and Shipment_Number filters are specified. MSi/mt/10-1-2002
--
CREATE PROCEDURE dbo.spXLA_BrowseEvent_NoProduct_PlantShipFilters 
