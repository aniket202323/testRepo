/* NOTE 
   ...
   ECR #24541:mt/1-15-2003:added Conformance & Testing_Prct_Complete
   ...
   (2) spXLA_BrowseEvent_NoProduct_ShipFilter 	  	  	 'This stored Procedure
...
*/
-- USAGE: 
-- spXLA_BrowseEvent_NoProduct_ShipFilter should be called when no-product join condition is met and 
-- Shipment_Number filter is specified.  MSi/mt/10-1-2002
--
CREATE PROCEDURE dbo.spXLA_BrowseEvent_NoProduct_ShipFilter 
...
CREATE TABLE #Events (Event_Num Varchar(50), Event_Id Int, Pu_Id Int, Start_Time DateTime, TimeStamp DateTime
                    ...
                    , Event_Conformance TinyInt NULL, Testing_Prct_Complete TinyInt NULL) --ECR #24541:mt/1-15-2003:added Conformance & Testing_Prct_Complete
  ...
  If @MyType = @NoStringHasStatusAsc --1
    BEGIN
        SELECT Primary_Event_Num = e.Event_Num, Event_Id = e.Event_Id,  Start_Time = e.Start_Time at time zone @DBTz at time zone @InTimeZone, TimeStamp = e.TimeStamp at time zone @DBTz at time zone @InTimeZone
             ...
             , ed.Initial_Dimension_A, ed.Initial_Dimension_X, ed.Initial_Dimension_Y, ed.Initial_Dimension_Z
             , ed.Final_Dimension_A, ed.Final_Dimension_X, ed.Final_Dimension_Y, ed.Final_Dimension_Z
             , ed.Orientation_X, ed.Orientation_Y, ed.Orientation_Z, co.Customer_Order_Number, co.Plant_Order_Number, e.Extended_Info
          FROM #Events e
          JOIN Prod_Units pu ON pu.Pu_Id = e.Pu_Id
          LEFT OUTER JOIN Event_Details ed ON ed.Event_Id = e.Event_Id
