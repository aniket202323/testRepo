/* NOTE 
   ...
   The 8 stored procedures are:
    (1) spXLA_BrowseEvent_Order 	  	  	  	 'Master Copy; This stored procedure/ mt/1-20-2003
...
*/
-- USAGE:
-- spXLA_BrowseEvent_Order should be called only when none of the filters are supplied (except for products), and 
-- the Order-Join condtions are met. mt/10-2-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Order_Bak_177] 
