/* NOTE 
   ...
   The 8 stored procedures are:
    ...
    (4) spXLA_BrowseEvent_Order_CustomerShipFilters 	  	 'This stored procedure
...
*/
-- USAGE:
-- spXLA_BrowseEvent_Order_CustomerShipFilters should be called only when none of the filters are supplied (except 
-- for products), the Order-Join condtions are met, Customer_Code AND Shipment_Number filters are specified. 
-- mt/10-3-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Order_CustomerShipFilters_Bak_177] 
