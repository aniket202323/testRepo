/* NOTE 
   ...
   MSi/mt/1-22-2002
   mt/1-20-2003; spXLA_BrowseEvent_Order_NPT is for event search with the join condition to retrieve order information.
   ...
   We chose NOT to add more branches of SQL Statements to spXLA_BrowseEvent_Order_NPT, but rather to expand 
   ...
   The 8 stored procedures are:
    (1) spXLA_BrowseEvent_Order_NPT 	  	  	  	 'Master Copy; This stored procedure/ mt/1-20-2003
    (2) spXLA_BrowseEvent_Order_NPT_ShipmentFilter
    (3) spXLA_BrowseEvent_Order_NPT_CustomerFilter
    (4) spXLA_BrowseEvent_Order_NPT_CustomerShipFilters
    (5) spXLA_BrowseEvent_Order_NPT_PlantFilter
    (6) spXLA_BrowseEvent_Order_NPT_PlantShipFilters
    (7) spXLA_BrowseEvent_Order_NPT_PlantCustomerFilters
    (8) spXLA_BrowseEvent_Order_NPT_PlantCustomerShip
*/
-- USAGE:
-- spXLA_BrowseEvent_Order_NPT should be called only when none of the filters are supplied (except for products), and 
-- the Order-Join condtions are met. mt/10-2-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Order_NPT_Bak_177] 
