/* NOTE 
   ...
   The 8 stored procedures are:
    ...
    (3) spXLA_BrowseEvent_Order_NPT_CustomerFilter          'mt/1-20-2003
...
*/
-- USAGE:
-- spXLA_BrowseEvent_Order_NPT_CustomerFilter should be called only when none of the filters are supplied (except 
-- for products), and the Order-Join condtions are met AND Customer_Code filter is specified. mt/10-2-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Order_NPT_CustomerFilter_Bak_177] 
