/* NOTE 
   ...
   The 8 stored procedures are:
    ...
    (5) spXLA_BrowseEvent_Order_NPT_PlantFilter 	  	 'this SP mt/1-20-2003
...
*/
-- USAGE:
-- spXLA_BrowseEvent_Order_NPT_PlantFilter should be called only when none of the filters are supplied (except for products), 
-- the Order-Join condtions are met, and Plant_Order_Number filter is specified. mt/10-2-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Order_NPT_PlantFilter_Bak_177] 
