/* NOTE 
   ...
   MSi/mt/1-22-2002
   mt/1-20-2003; spXLA_BrowseEvent_Order is for event search with the join condition to retrieve order information.
   ...
   We chose NOT to add more branches of SQL Statements to spXLA_BrowseEvent_Order, but rather to expand 
   ...
   The 8 stored procedures are:
    (1) spXLA_BrowseEvent_Order 	  	  	  	 'Master Copy
    (2) spXLA_BrowseEvent_Order_NPT_ShipFilter 	  	 'This stored procedure/mt/1-20-2003
    (3) spXLA_BrowseEvent_Order_CustomerFilter
    (4) spXLA_BrowseEvent_Order_CustomerShipFilters
    (5) spXLA_BrowseEvent_Order_PlantFilter
    (6) spXLA_BrowseEvent_Order_PlantShipFilters
    (7) spXLA_BrowseEvent_Order_PlantCustomerFilters
    (8) spXLA_BrowseEvent_Order_PlantCustomerShip     
*/
-- USAGE:
-- spXLA_BrowseEvent_Order_NPT_ShipFilter should be called only when none of the filters are supplied (except 
-- for products), and the Order-Join condtions is met AND Shipment_Number filter is specified. Mt/10-2-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Order_NPT_ShipFilter_Bak_177] 
...
CREATE TABLE #Events (Event_Num Varchar(25), Event_Id Int, Pu_Id Int, Prod_Id Int, Start_Time DateTime, TimeStamp DateTime
                    ...
                    , Event_Conformance TinyInt NULL, Testing_Prct_Complete TinyInt NULL, NPT tinyint NULL )     --ECR #24541: mt/1-20-2003
      ...
      BEGIN
        INSERT INTO #Events
          SELECT e.Event_Num, e.Event_Id, e.Pu_Id, ps.Prod_Id, COALESCE(e.Start_Time, DATEADD(ss, -1, e.TimeStamp)), e.TimeStamp, e.Extended_Info, e.Event_Status, e.Applied_Product
               , e.Conformance, e.Testing_Prct_Complete ,NULL                                      --ECR #24541: mt/1-20-2003
            FROM Events e
