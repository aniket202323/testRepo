/* NOTE 
   ...
   The 8 stored procedures are:
    ...
    (7) spXLA_BrowseEvent_Order_PlantCustomerFilters 	 'This SP: mt/1-20-2003
    (8) spXLA_BrowseEvent_Order_PlantCustomerShip
*/
-- USAGE:
-- spXLA_BrowseEvent_Order_PlantCustomerFilters should be called only when none of the filters are supplied (except 
-- for products), the Order-Join condtions are met, and Plant_Order_Number and Customer_Code filters are specified. 
-- mt/10-3-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Order_PlantCustomerFilters_Bak_177] 
