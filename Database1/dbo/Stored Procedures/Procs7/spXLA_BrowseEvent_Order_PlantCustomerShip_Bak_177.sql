/* NOTE 
   ...
   The 8 stored procedures are:
    ...
    (8) spXLA_BrowseEvent_Order_PlantCustomerShip 	 'mt/1-20-2003
*/
-- USAGE:
-- spXLA_BrowseEvent_Order_PlantCustomerShip should be called only the Order-Join condtions are met, 
-- and Plant_Order_Number, Customer_Code, and Shipment_Number filters are specified. mt/10-3-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Order_PlantCustomerShip_Bak_177] 
