/* NOTE 
   ...
   The 8 stored procedures are:
    ...
    (6) spXLA_BrowseEvent_Order_PlantShipFilters 	 'This SP: mt/1-20-2003
    (7) spXLA_BrowseEvent_Order_PlantCustomerFilters
    (8) spXLA_BrowseEvent_Order_PlantCustomerShip
*/
-- USAGE:
-- spXLA_BrowseEvent_Order_PlantShipFilters should be called only when none of the filters are supplied (except 
-- for products), the Order-Join condtions are met, and Plant_Order_Number & Shipment_Number filters are specified. 
-- mt/10-3-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Order_PlantShipFilters_Bak_177] 
