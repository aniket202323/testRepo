/* NOTE 
   ...
   The 8 stored procedures are:
    ...
    (2) spXLA_BrowseEvent_Order_ShipFilter 	  	 'This stored procedure/mt/1-20-2003
...
*/
-- USAGE:
-- spXLA_BrowseEvent_Order_ShipFilter should be called only when none of the filters are supplied (except 
-- for products), and the Order-Join condtions is met AND Shipment_Number filter is specified. Mt/10-2-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Order_ShipFilter_Bak_177] 
