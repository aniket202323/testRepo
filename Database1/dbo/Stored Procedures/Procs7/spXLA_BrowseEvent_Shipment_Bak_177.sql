/* NOTE 
   ...
   (1) spXLA_BrowseEvent_Shipment 	  	  	  	  	 'Master copy; This stored Procedure
...
*/
-- USAGE: 
-- spXLA_BrowseEvent_Shipment should be called when shipment join condition (see above) is met and no filters are specified.
-- MSi/mt/10-2-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Shipment_Bak_177] 
