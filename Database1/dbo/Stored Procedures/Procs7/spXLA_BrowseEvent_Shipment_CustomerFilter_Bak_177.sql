/* NOTE 
   ...
   (3) spXLA_BrowseEvent_Shipment_CustomerFilter 	  	  	 'This stored Procedure: mt/01-22-2003
...
*/
-- USAGE: 
-- spXLA_BrowseEvent_Shipment_CustomerFilter should be called when shipment join condition (see above) is met and 
-- Customer_Code filter is specified. MSi/mt/10-2-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Shipment_CustomerFilter_Bak_177] 
