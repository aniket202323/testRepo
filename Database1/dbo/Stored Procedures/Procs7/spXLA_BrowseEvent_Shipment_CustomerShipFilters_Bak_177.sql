/* NOTE 
   ...
   (4) spXLA_BrowseEvent_Shipment_CustomerShipFilters 	  	  	 'This stored Procedure: mt/01-22-2003
...
*/
-- USAGE: 
-- spXLA_BrowseEvent_Shipment_CustomerShipFilters should be called when shipment join condition (see above) is met and 
-- Customer_Code filter AND Shipment_Number filter are specified. mt/10-2-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Shipment_CustomerShipFilters_Bak_177] 
