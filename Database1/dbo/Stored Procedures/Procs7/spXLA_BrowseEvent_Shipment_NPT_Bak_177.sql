/* NOTE 
   ...
   NOT to add more branches of SQL Statement into spXLA_BrowseEvent_Shipment_NPT but to expand into 8 stored procedures listed 
   below. Future bug fix to core code, if any, should be done in all 8 stored procedures.  
   The 8 stored procedures are:
   (1) spXLA_BrowseEvent_Shipment_NPT 	  	  	  	  	 'Master copy; This stored Procedure
...
*/
-- USAGE: 
-- spXLA_BrowseEvent_Shipment_NPT should be called when shipment join condition (see above) is met and no filters are specified.
-- MSi/mt/10-2-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Shipment_NPT_Bak_177] 
