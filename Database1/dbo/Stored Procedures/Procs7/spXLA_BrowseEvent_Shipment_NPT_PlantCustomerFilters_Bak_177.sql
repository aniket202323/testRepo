/* NOTE 
   ...
   (7) spXLA_BrowseEvent_Shipment_NPT_PlantCustomerFilters 	  	  	 'This stored Procedure: mt/01-22-2003
   (8) spXLA_BrowseEvent_Shipment_PlantCustomerShip
*/
-- USAGE: 
-- spXLA_BrowseEvent_Shipment_NPT_PlantCustomerFilters should be called when shipment join condition (see above) is met and
-- Plant_Order_Number AND Customer_Code filters are specified.  MSi/mt/10-2-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Shipment_NPT_PlantCustomerFilters_Bak_177] 
