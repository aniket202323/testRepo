/* NOTE 
   Added Crew,Shift: Defect #24503: mt/10-2-2002
   ...
   (5) spXLA_BrowseEvent_Shipment_NPT_PlantFilter 	  	  	  	 'This stored procedure: mt/01-22-2003
...
*/
-- USAGE: 
-- spXLA_BrowseEvent_Shipment_NPT_PlantFilter should be called when shipment join condition (see above) is met and
-- Plant_Order_Number filter is specified.  MSi/mt/10-2-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Shipment_NPT_PlantFilter_Bak_177] 
