/* NOTE 
   ...
   (8) spXLA_BrowseEvent_Shipment_PlantCustomerShip 	  	 'This stored Procedure; name is under 50-char limit : mt/01-22-2003
*/
-- USAGE: 
-- spXLA_BrowseEvent_Shipment_PlantCustomerShip should be called when shipment join condition (see above) is met and
-- Plant_Order_Number, Customer_Code, and Shipment_Number filters are specified.  mt/10-2-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Shipment_PlantCustomerShip_Bak_177] 
...
CREATE TABLE #Events (Event_Num Varchar(25), Event_Id Int, Pu_Id Int, Prod_Id Int, Start_Time DateTime, TimeStamp DateTime
                    ...
                    , Event_Conformance TinyInt NULL, Testing_Prct_Complete TinyInt NULL )   -- ECR #24541: mt/1-22-2003
      ...
      BEGIN
        INSERT INTO #Events
          SELECT e.Event_Num, e.Event_Id, e.Pu_Id, ps.Prod_Id, COALESCE(e.Start_Time, DATEADD(ss, -1, e.TimeStamp)), e.TimeStamp, e.Extended_Info, e.Event_Status, e.Applied_Product
               , e.Conformance, e.Testing_Prct_Complete                                       --ECR #24541: mt/1-22-2003
            FROM Events e
