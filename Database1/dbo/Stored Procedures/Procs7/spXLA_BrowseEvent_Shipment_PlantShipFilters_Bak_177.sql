/* NOTE 
   ...
   (6) spXLA_BrowseEvent_Shipment_PlantShipFilters 	  	  	 'This stored Procedure: mt/01-22-2003
   (7) spXLA_BrowseEvent_Shipment_PlantCustomerFilters
   (8) spXLA_BrowseEvent_Shipment_PlantCustomerShip
*/
-- USAGE: 
-- spXLA_BrowseEvent_Shipment_PlantShipFilters should be called when shipment join condition (see above) is met and
-- Plant_Order_Number AND Shipment_Number filters are specified.  mt/10-2-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Shipment_PlantShipFilters_Bak_177] 
