/* NOTE 
   ...
   (2) spXLA_BrowseEvent_Shipment_ShipFilter 	  	  	 'This SP: mt/01-22-2003
...
*/
-- USAGE: 
-- spXLA_BrowseEvent_Shipment_ShipFilter should be called when shipment join condition (see above) is met and
-- Shipment_Number filter is specified. mt/10-2-2002
--
CREATE PROCEDURE dbo.[spXLA_BrowseEvent_Shipment_ShipFilter_Bak_177] 
