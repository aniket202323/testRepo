-- DESCRIPTION: spXLA_DowntimeDT_NoProduct is modified from spXLA_DowntimeDetail_NoProduct_New. Changes includes
...
--
CREATE PROCEDURE dbo.spXLA_DowntimeDT_NoProduct
 	   @Start_Time 	 DateTime
 	 , @End_Time 	 DateTime
...
-- --------------------------------------------------
  ...
  If @TimeSort = 1
    If @MasterUnit Is NULL
      BEGIN
           SELECT D.Detail_Id 
 	  	  	  	 , [Start_Time] = D.Start_Time at time zone @DBTz at time zone @InTimeZone
