-- DESCRIPTION: spXLA_DowntimeDetail_AP_NPT() handle down time detail with original or applied product filter only. The No-Product 
...
--
CREATE PROCEDURE dbo.[spXLA_DowntimeDetail_AP_NPT_Bak_177]
 	   @Start_Time 	  	 DateTime
 	 , @End_Time 	  	 DateTime
...
If @TimeSort = 1
  If @MasterUnit Is NULL
    BEGIN
        SELECT [Start_Time] = dbo.fnServer_CmnConvertFromDbTime(D.Start_Time,@InTimeZone)
