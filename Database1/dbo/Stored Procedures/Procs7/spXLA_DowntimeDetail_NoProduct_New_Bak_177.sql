-- DESCRIPTION: spXLA_DowntimeDetail_NoProduct_New is modified from spXLA_DowntimeDetail_NoProduct. Changes includes
-- (a) new field name (Unit instead of Line)
-- (b) Uptime added.
-- mt/7-1-2002
CREATE PROCEDURE dbo.[spXLA_DowntimeDetail_NoProduct_New_Bak_177]
 	   @Start_Time 	 datetime
 	 , @End_Time 	 datetime
