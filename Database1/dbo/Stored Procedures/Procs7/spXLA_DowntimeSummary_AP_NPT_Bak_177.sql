-- DESCRIPTION: spXLA_DowntimeSummary_AP_NPT handles both original and applied product filter. Any product is not a valid option
...
--
CREATE PROCEDURE dbo.[spXLA_DowntimeSummary_AP_NPT_Bak_177]
 	   @Start_Time 	  	 DateTime
 	 , @End_Time 	  	 DateTime
