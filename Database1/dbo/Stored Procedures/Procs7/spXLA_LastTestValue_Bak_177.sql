CREATE Procedure dbo.[spXLA_LastTestValue_Bak_177]
 	   @Var_Id 	 Integer
 	 , @Pu_Id 	 Integer
...
SELECT    @Test_Id as 'Test_Id'
 	  	 ...
 	  	 , [Result_On] = dbo.fnServer_CmnConvertFromDbTime(@Result_On,@InTimeZone)
 	  	 , [Entry_On] = dbo.fnServer_CmnConvertFromDbTime(@Entry_On,@InTimeZone)
