...
CREATE PROCEDURE dbo.spXLA_TestsDataByTestName_AP
...
CREATE TABLE #VariablesAndEvents ( Master_Unit Int, PU_Id Int, Var_Id Int, Var_Desc Varchar(50), Data_Type_Id Int
                                 , Event_Num Varchar(50), Event_Id Int, Event_Type Int NULL, Event_Status Int NULL, Start_Time DateTime NULL, TimeStamp DateTime, Applied_Product Int NULL )
