-- DESCRIPTION: spXLA_UserDefinedEventSUMM_AP_NPT() 
--
-- ECR #27889 (mt/4-26-2004) 
--
CREATE PROCEDURE dbo.spXLA_UserDefinedEventSUMM_AP_NPT
 	   @Start_Time 	  	 DateTime
 	 , @End_Time 	  	 DateTime
 	 , @PU_Id 	  	 Int 	  	 
...
--  UPDATE #TempUDE  SET Reason_Name = dbo.fnDBTranslate(@LangId, 38333, 'Unspecified') WHERE Reason_Name Is NULL
  ...
  INSERT INTO #MyReport ( ReasonName,    NumberOfOccurances, TotalReasonMinutes,               AvgReasonMinutes,                    TotalUserDefinedEventMinutes,  TotalOperatingMinutes )
       SELECT             D.Reason_Name, @NOF,  Total_Duration = SUM(D.Duration), (SUM(D.Duration) / @NOF), @TotalUserDefinedEventMinutes, @TotalOperating
         FROM #TempUDE D
