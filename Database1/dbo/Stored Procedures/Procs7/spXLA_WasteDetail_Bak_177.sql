Create Procedure dbo.[spXLA_WasteDetail_Bak_177]
@STime datetime,
@ETime datetime,
@PU_Id int,
@SelectSource int,
...
insert into #TopNDR (Detail_Id, TimeStamp, Amount, SourcePU, R1_Id, R2_Id, R3_Id, R4_Id, Type_Id, Meas_Id, Prod_Id, EventBased, EventNumber)
  select D.WED_Id,  EV.TimeStamp, D.Amount, D.Source_PU_Id, D.Reason_Level1, D.Reason_Level2,D.Reason_Level3,D.Reason_Level4,D.WET_Id,D.WEMT_Id,PS.Prod_Id, 1, EV.Event_Num 
  From Events EV 
