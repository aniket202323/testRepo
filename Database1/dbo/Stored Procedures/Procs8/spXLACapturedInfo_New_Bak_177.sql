...
--
CREATE PROCEDURE dbo.[spXLACapturedInfo_New_Bak_177] 
 	   @Start_Time  	  	 DateTime
 	 , @End_Time  	  	 DateTime
 	 , @Pu_Id  	  	 Integer
...
DO_PRODUCT_CODE_SQL:
  ...
  If @QueryType = @NoProductInfoNoEndTime
    BEGIN
      If @TimeSort = 1  --Ascending
          SELECT p.Prod_Code,ds.DSet_Id,ds.Comment_Id,ds.Operator,ds.Prod_Id,ds.PU_Id,[Timestamp] = dbo.fnServer_CmnConvertFromDbTime(ds.Timestamp,@InTimeZone)
            FROM gb_dset ds
