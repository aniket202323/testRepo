--spXLALastRunData_New is modified from spXLALastRunData_Expand. Changes are
--  (1) Internal lookup of Pu_Id & Data_Type_Id, XLA no longer has to do that before calling stored procedure.
--  (2) Product Code, if asked for, is included in resultSet
--  (3) Data_Type_Id is included in resultSet.
--
CREATE PROCEDURE dbo.[spXLALastRunData_New_Bak_177]  
 	   @Var_Id  	  	 Integer
 	 , @Var_Desc 	  	 Varchar(50)
 	 , @Prod_Id  	  	 Integer
 	 , @Group_Id  	  	 Integer
