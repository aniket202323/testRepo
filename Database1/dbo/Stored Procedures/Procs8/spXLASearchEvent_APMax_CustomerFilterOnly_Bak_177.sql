/* NOTE ON spXLASearchEvent_APMax: Derived from spXLASearchEvent, this stored procedure adds the ability to
   ...
   (3) spXLASearchEvent_APMax_CustomerFilterOnly 	  	 'This stored Procedure; 1-22-2002
...
*/
-- USAGE: 
-- spXLASearchEvent_APMax_CustomerFilterOnly should be called only when Customer_Code is specified. MSi/mt/1-24-2002
--
CREATE PROCEDURE dbo.[spXLASearchEvent_APMax_CustomerFilterOnly_Bak_177] 
