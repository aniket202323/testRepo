/* NOTE ON spXLASearchEvent_APMax: Derived from spXLASearchEvent, this stored procedure adds the ability to
   ...
   (7) spXLASearchEvent_APMax_PlantAndCustomerFilters 	  	 'This stored Procedure; mt/1-23-2002
   (8) spXLASearchEvent_APMax_PlantCustomerAndShip
*/
-- USAGE: 
-- spXLASearchEvent_APMax_PlantAndCustomerFilters should be called only with Customer_Code as 
-- the only filter supplied. MSi/mt/1-24-2002
--
CREATE PROCEDURE dbo.[spXLASearchEvent_APMax_PlantAndCustomerFilters_Bak_177] 
