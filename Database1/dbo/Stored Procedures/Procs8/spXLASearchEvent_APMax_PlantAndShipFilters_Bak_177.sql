/* NOTE ON spXLASearchEvent_APMax: Derived from spXLASearchEvent, this stored procedure adds the ability to
   ...
   (6) spXLASearchEvent_APMax_PlantAndShipFilters 	  	 'This stored Procedure; mt/1-23-2002
   (7) spXLASearchEvent_APMax_PlantAndCustomerFilters
   (8) spXLASearchEvent_APMax_PlantCustomerAndShip
*/
-- USAGE: 
-- spXLASearchEvent_APMax_PlantAndShipFilters should be called when Plant_Order_Number and Shipment_Number
-- filters are specified. MSi/mt/1-22-2002
--
CREATE PROCEDURE dbo.[spXLASearchEvent_APMax_PlantAndShipFilters_Bak_177] 
