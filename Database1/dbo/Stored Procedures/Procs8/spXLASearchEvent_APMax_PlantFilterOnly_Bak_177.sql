/* NOTE ON spXLASearchEvent_APMax: Derived from spXLASearchEvent, this stored procedure adds the ability to
   ...
   (5) spXLASearchEvent_APMax_PlantFilterOnly 	  	  	 ;This stored Procedure; mt/1-22-2002
...
*/
-- USAGE: 
-- spXLASearchEvent_APMax_PlantFilterOnly should be called only when Plant_Order_Number is specified; MSi/mt/1-24-2002
--
CREATE PROCEDURE dbo.[spXLASearchEvent_APMax_PlantFilterOnly_Bak_177] 
  ...
  If @MyType = @NoStringHasStatusAsc --1
    BEGIN
         SELECT Primary_Event_Num = e.Event_Num
           ...
           LEFT OUTER JOIN Customer_Order_Line_Items l ON l.Order_Line_Id = ed.Order_Line_Id                    --2002Jan22;mt
           JOIN  Customer_Orders co ON co.Order_Id = l.Order_Id AND co.Plant_Order_Number = @Plant_Order_Number --2002Jan22;mt
