/* NOTE ON spXLASearchEvent_APMax: Derived from spXLASearchEvent, this stored procedure adds the ability to
   ...
   (1) spXLASearchEvent_APMax 	  	  	  	  	 'Master copy; This stored Procedure
...
*/
-- USAGE: 
-- spXLASearchEvent_APMax_ShipFilterOnly should be called when Shipment_Number filter is specified. MSi/mt/1-22-2002
--
CREATE PROCEDURE dbo.[spXLASearchEvent_APMax_ShipFilterOnly_Bak_177] 
  ...
  If @MyType = @NoStringHasStatusAsc --1
    BEGIN
         SELECT Primary_Event_Num = e.Event_Num
           ...
           LEFT OUTER JOIN Shipment_Line_Items sl ON sl.Shipment_Item_Id = ed.Shipment_Item_Id              --22-Jan-02;mt
           JOIN Shipment sh ON sh.Shipment_Id = sl.Shipment_Id AND sh.Shipment_Number = @Shipment_Number    --22-Jan-02;mt
