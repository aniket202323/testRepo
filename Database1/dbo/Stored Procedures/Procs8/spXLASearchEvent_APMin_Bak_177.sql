/* NOTE ON spXLASearchEvent_APMin: Derived from spXLASearchEvent, this stored procedure adds the ability to
   ...
   The 8 stored procedures are:
    (1) spXLASearchEvent_APMin 	  	  	  	 'Master Copy; This stored procedure
...
*/
-- USAGE: 
-- spXLASearchEvent_APMin should be called only when minimum join condition is met. MSi/mt/1-22-2002
--
CREATE PROCEDURE dbo.[spXLASearchEvent_APMin_Bak_177] 
