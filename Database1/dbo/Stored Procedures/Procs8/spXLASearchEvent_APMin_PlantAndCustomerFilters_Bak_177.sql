/* NOTE ON spXLASearchEvent_APMin: Derived from spXLASearchEvent, this stored procedure adds the ability to
   ...
   The 8 stored procedures are:
    ...
    (7) spXLASearchEvent_APMin_PlantAndCustomerFilters 	 'This stored procedure; mt/1-23-2002
    (8) spXLASearchEvent_APMin_PlantCustomerAndShip
*/
-- USAGE: 
-- spXLASearchEvent_APMin_PlantAndCustomerFilters should be called only when minimum join condition is met AND 
-- Plant_Order_Number and Customer_Code filters are specified. MSi/mt/1-23-2002
--
CREATE PROCEDURE dbo.[spXLASearchEvent_APMin_PlantAndCustomerFilters_Bak_177] 
