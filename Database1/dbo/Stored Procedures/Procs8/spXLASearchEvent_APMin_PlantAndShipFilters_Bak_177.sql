/* NOTE ON spXLASearchEvent_APMin: Derived from spXLASearchEvent, this stored procedure adds the ability to
   ...
   The 8 stored procedures are:
    ...
    (6) spXLASearchEvent_APMin_PlantAndShipFilters 	 'This stored procedure; mt/1-23-2002
    (7) spXLASearchEvent_APMin_PlantAndCustomerFilters
    (8) spXLASearchEvent_APMin_PlantCustomerAndShip
*/
-- USAGE: 
-- spXLASearchEvent_APMin_PlantAndShipFilters should be called only when minimum join condition is met AND 
-- Plant_Order_Number and Shipment_Number Filters are specified. MSi/mt/1-23-2002
--
CREATE PROCEDURE dbo.[spXLASearchEvent_APMin_PlantAndShipFilters_Bak_177] 
