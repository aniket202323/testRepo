/* NOTE ON spXLASearchEvent_APMin: Derived from spXLASearchEvent, this stored procedure adds the ability to
   ...
   The 8 stored procedures are:
    ...
    (4) spXLASearchEvent_APMin_CustomerAndShipFilters
    ...
    (8) spXLASearchEvent_APMin_PlantCustomerAndShip 	 'This stored procedure; mt/1-23-2002
*/
-- USAGE: 
-- spXLASearchEvent_APMin_PlantCustomerAndShip should be called only when minimum join condition is met AND 
-- Plant_Order_Number, Customer_Code, & Shipment_Number filters are specified. MSi/mt/1-23-2002
--
CREATE PROCEDURE dbo.[spXLASearchEvent_APMin_PlantCustomerAndShip_Bak_177] 
  ...
  Else If @MyType = @NoStringHasStatusDesc --2
    BEGIN
        SELECT Primary_Event_Num = e.Event_Num
          ...
          JOIN Customer_Orders co ON co.Order_Id = l.Order_Id AND co.Plant_Order_Number = @Plant_Order_Number --23Jan02;mt
