/* NOTE ON spXLASearchEvent_APMin: Derived from spXLASearchEvent, this stored procedure adds the ability to
   ...
   The 8 stored procedures are:
    ...
    (5) spXLASearchEvent_APMin_PlantFilterOnly 	  	 'This stored procedure; mt/1-23-2002
...
*/
-- USAGE: 
-- spXLASearchEvent_APMin_PlantFilterOnly should be called only when minimum join condition is met AND Plant_Order_Number
-- filter is specified. MSi/mt/1-23-2002
--
CREATE PROCEDURE dbo.[spXLASearchEvent_APMin_PlantFilterOnly_Bak_177] 
