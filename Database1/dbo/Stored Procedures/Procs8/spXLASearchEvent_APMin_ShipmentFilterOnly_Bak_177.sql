/* NOTE ON spXLASearchEvent_APMin: Derived from spXLASearchEvent, this stored procedure adds the ability to
   ...
   The 8 stored procedures are:
    ...
    (2) spXLASearchEvent_APMIN_ShipmentFilterOnly 	 'This stored procedure; mt/1-23-2002
...
*/
-- USAGE: 
-- spXLASearchEvent_APMin_ShipmentFilterOnly should be called only when minimum join condition is met AND Shipment_Number
-- filter is specified. MSi/mt/1-23-2002
--
CREATE PROCEDURE dbo.[spXLASearchEvent_APMin_ShipmentFilterOnly_Bak_177] 
