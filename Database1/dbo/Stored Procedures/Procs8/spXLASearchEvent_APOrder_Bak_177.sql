...
*/
-- USAGE:
-- spXLASearchEvent_APOrder should be called only when none of the filters are supplied (except for products), and 
-- the Order-Join condtions are met. MSi/mt/1-23-2002
--
CREATE PROCEDURE dbo.[spXLASearchEvent_APOrder_Bak_177] 
