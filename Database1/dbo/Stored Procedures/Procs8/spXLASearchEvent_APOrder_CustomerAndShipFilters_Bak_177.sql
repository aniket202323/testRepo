/* NOTE ON spXLASearchEvent_APOrder: Derived from spXLASearchEvent_APMax (<spXLASearchEvent). The suffix _AP indicate
   ...
   The 8 stored procedures are:
    ...
    (4) spXLASearchEvent_APOrder_CustomerAndShipFilters 	  	 'This stored procedure
...
*/
-- USAGE:
-- spXLASearchEvent_APOrder_CustomerAndShipFilters should be called only when none of the filters are supplied (except 
-- for products), the Order-Join condtions are met, Customer_Code AND Shipment_Number filters are specified. 
-- MSi/mt/1-24-2002
--
CREATE PROCEDURE dbo.[spXLASearchEvent_APOrder_CustomerAndShipFilters_Bak_177] 
