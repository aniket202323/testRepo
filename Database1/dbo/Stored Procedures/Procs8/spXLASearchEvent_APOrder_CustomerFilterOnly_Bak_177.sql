...
*/
-- USAGE:
-- spXLASearchEvent_APOrder_CustomerFilterOnly should be called only when none of the filters are supplied (except 
-- for products), and the Order-Join condtions are met AND Customer_Code filter is specified. MSi/mt/1-23-2002
--
CREATE PROCEDURE dbo.[spXLASearchEvent_APOrder_CustomerFilterOnly_Bak_177] 
