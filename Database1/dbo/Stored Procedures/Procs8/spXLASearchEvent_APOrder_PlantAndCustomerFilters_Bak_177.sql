...
*/
-- USAGE:
-- spXLASearchEvent_APOrder_PlantAndCustomerFilters should be called only when none of the filters are supplied (except 
-- for products), the Order-Join condtions are met, and Plant_Order_Number and Customer_Code filters are specified. 
-- MSi/mt/1-24-2002
--
CREATE PROCEDURE dbo.[spXLASearchEvent_APOrder_PlantAndCustomerFilters_Bak_177] 
