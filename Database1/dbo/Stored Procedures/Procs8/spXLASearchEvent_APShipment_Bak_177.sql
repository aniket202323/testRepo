...
*/
-- USAGE: 
-- spXLASearchEvent_APShipment should be called when shipment join condition (see above) is met and no filters are specified.
-- MSi/mt/1-24-2002
--
CREATE PROCEDURE dbo.[spXLASearchEvent_APShipment_Bak_177] 
