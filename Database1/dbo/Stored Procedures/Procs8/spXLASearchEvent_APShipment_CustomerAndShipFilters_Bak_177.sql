/* NOTE ON spXLASearchEvent_APShipment: Derived from spXLASearchEvent, this stored procedure adds the ability to
   ...
   (4) spXLASearchEvent_APShipment_CustomerAndShipFilters 	  	 'This stored Procedure
   (5) spXLASearchEvent_APShipment_PlantFilterOnly
   (6) spXLASearchEvent_APShipment_PlantAndShipFilters
   (7) spXLASearchEvent_APShipment_PlantAndCustomerFilters
   (8) spXLASearchEvent_APShipment_PlantCustomerAndShip
*/
-- USAGE: 
-- spXLASearchEvent_APShipment_CustomerAndShipFilters should be called when shipment join condition (see above) is met and 
-- Customer_Code filter AND Shipment_Number filter are specified. MSi/mt/1-24-2002
--
CREATE PROCEDURE dbo.[spXLASearchEvent_APShipment_CustomerAndShipFilters_Bak_177] 
  ...
  If @MyType = @NoStringHasStatusAsc --1
    BEGIN
        SELECT Primary_Event_Num = e.Event_Num
          ...
          JOIN Customer_Orders co ON co.Order_Id = l.Order_Id                                      --24Jan02;mt
