/* NOTE ON spXLASearchEvent_APShipment: Derived from spXLASearchEvent, this stored procedure adds the ability to
   ...
   (3) spXLASearchEvent_APShipment_CustomerFilterOnly 	  	  	 'This stored Procedure
...
*/
-- USAGE: 
-- spXLASearchEvent_APShipment_CustomerFilterOnly should be called when shipment join condition (see above) is met and 
-- Customer_Code filter is specified. MSi/mt/1-24-2002
--
CREATE PROCEDURE dbo.[spXLASearchEvent_APShipment_CustomerFilterOnly_Bak_177] 
