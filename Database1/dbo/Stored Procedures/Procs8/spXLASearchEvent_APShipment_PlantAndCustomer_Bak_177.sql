/* NOTE ON spXLASearchEvent_APShipment: Derived from spXLASearchEvent, this stored procedure adds the ability to
   ...
   (7) spXLASearchEvent_APShipment_PlantAndCustomer 	  	 'This stored Procedure; name is under 50-char limit 
   (8) spXLASearchEvent_APShipment_PlantCustomerAndShip
*/
-- USAGE: 
-- spXLASearchEvent_APShipment_PlantAndCustomer should be called when shipment join condition (see above) is met and
-- Plant_Order_Number AND Customer_Code filters are specified.  MSi/mt/1-25-2002
--
CREATE PROCEDURE dbo.[spXLASearchEvent_APShipment_PlantAndCustomer_Bak_177] 
