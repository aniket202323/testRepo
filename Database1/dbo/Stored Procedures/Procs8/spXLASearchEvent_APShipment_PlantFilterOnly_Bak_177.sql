/* NOTE ON spXLASearchEvent_APShipment: Derived from spXLASearchEvent, this stored procedure adds the ability to
   ...
   (1) spXLASearchEvent_APShipment 	  	  	  	  	 'Master copy; This stored Procedure
...
*/
-- USAGE: 
-- spXLASearchEvent_APShipment_PlantFilterOnly should be called when shipment join condition (see above) is met and
-- Plant_Order_Number filter is specified.  MSi/mt/1-24-2002
--
CREATE PROCEDURE dbo.[spXLASearchEvent_APShipment_PlantFilterOnly_Bak_177] 
