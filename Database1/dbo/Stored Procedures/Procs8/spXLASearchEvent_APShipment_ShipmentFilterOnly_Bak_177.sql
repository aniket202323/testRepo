...
*/
-- USAGE: 
-- spXLASearchEvent_APShipment_ShipmentFilterOnly should be called when shipment join condition (see above) is met and
-- Shipment_Number filter is specified. MSi/mt/1-24-2002
--
CREATE PROCEDURE dbo.[spXLASearchEvent_APShipment_ShipmentFilterOnly_Bak_177] 
