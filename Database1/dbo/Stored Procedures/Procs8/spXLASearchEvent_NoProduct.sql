/* NOTE ON spXLASearchEvent_NoProduct: Derived from spXLASearchEvent_APMax with the "Applied Product" code removed. Thus
   ...
   (1) spXLASearchEvent_NoProduct 	  	  	  	  	 'Master copy; This stored Procedure
...
*/
-- USAGE: 
-- spXLASearchEvent_NoProduct should be called when no-product join condition is met and no filters are specified.
-- MSi/mt/1-25-2002
--
CREATE PROCEDURE dbo.spXLASearchEvent_NoProduct 
