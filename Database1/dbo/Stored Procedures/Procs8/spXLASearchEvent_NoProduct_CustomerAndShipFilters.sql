/* NOTE ON spXLASearchEvent_NoProduct: Derived from spXLASearchEvent_APMax with the "Applied Product" code removed. Thus
   ...
   (4) spXLASearchEvent_NoProduct_CustomerAndShipFilters 	 'This stored Procedure
...
*/
-- USAGE: 
-- spXLASearchEvent_NoProduct_CustomerAndShipFilters should be called when no-product join condition is met and 
-- Customer_Code and Shipment_Number filters are specified. MSi/mt/1-29-2002
--
CREATE PROCEDURE dbo.spXLASearchEvent_NoProduct_CustomerAndShipFilters 
  ...
  If @MyType = @NoStringHasStatusAsc --1
    BEGIN
        SELECT Primary_Event_Num = e.Event_Num
          ...
          LEFT OUTER JOIN Shipment_Line_Items sl ON sl.Shipment_Item_Id = ed.Shipment_Item_Id           --29Jan02;mt
          JOIN Shipment sh ON sh.Shipment_Id = sl.Shipment_Id AND sh.Shipment_Number = @Shipment_Number --29Jan02;mt
