/* NOTE ON spXLASearchEvent_NoProduct: Derived from spXLASearchEvent_APMax with the "Applied Product" code removed. Thus
   ...
   (6) spXLASearchEvent_NoProduct_PlantAndShipFilters 	  	 'This stored Procedure
   (7) spXLASearchEvent_NoProduct_PlantAndCustomerFilters
   (8) spXLASearchEvent_NoProduct_PlantCustomerAndShip
*/
-- USAGE: 
-- spXLASearchEvent_NoProduct_PlantAndShipFilters should be called when no-product join condition is met and 
-- Plant_Order_Number and Shipment_Number filters are specified. MSi/mt/1-29-2002
--
CREATE PROCEDURE dbo.spXLASearchEvent_NoProduct_PlantAndShipFilters 
