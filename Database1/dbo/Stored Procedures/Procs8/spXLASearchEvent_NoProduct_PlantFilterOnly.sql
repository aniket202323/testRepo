/* NOTE ON spXLASearchEvent_NoProduct: Derived from spXLASearchEvent_APMax with the "Applied Product" code removed. Thus
   ...
   (5) spXLASearchEvent_NoProduct_PlantFilterOnly 	  	 'This stored Procedure
...
*/
-- USAGE: 
-- spXLASearchEvent_NoProduct_PlantFilterOnly should be called when no-product join condition is met and 
-- Plant_Order_Number is specified. MSi/mt/1-29-2002
--
CREATE PROCEDURE dbo.spXLASearchEvent_NoProduct_PlantFilterOnly 
