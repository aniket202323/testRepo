-- spXLAWbWiz_ReportSystemParameters returns all available parameters excluding system parameter (Is_Default = 1)
--
CREATE PROCEDURE dbo.spXLAWbWiz_ReportSystemParameters
AS
