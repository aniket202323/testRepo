-- DESCRIPTION: spXLA_WasteDT_AP_NPT is based on spXLA_WasteDetail_AP. Defect #24327:mt/9-4-2002.
...
CREATE PROCEDURE dbo.[spXLA_WasteDT_AP_NPT_Bak_177]
 	   @Start_Time  	  	 DateTime
 	 , @End_Time  	  	 DateTime
 	 , @Pu_Id  	  	 Int
 	 , @SelectSource  	 Int
...
CREATE TABLE #Applied_Products(Pu_Id Int, Event_Id Int, Event_Num Varchar(25), Prod_Id Int, Applied_Prod_Id Int NULL, Start_Time DateTime, TimeStamp DateTime )
...
NOCREW_NOSHIFT_ORIGINAL_INSERT:
  If @MasterUnit Is NULL
    BEGIN
      ...
      INSERT INTO #TopNDR (Detail_Id, Start_Time,TimeStamp, WasteTimeStamp, Amount, SourcePU, Cause_Comment_Id, R1_Id, R2_Id, R3_Id, R4_Id, A1_Id, A2_Id, A3_Id, A4_Id, Type_Id, Meas_Id, Prod_Id, EventBased, EventNumber)
        SELECT D.WED_Id, EV.Start_Time, EV.TimeStamp, D.TimeStamp, D.Amount, D.Source_Pu_Id, D.Cause_Comment_Id, D.Reason_Level1, D.Reason_Level2, D.Reason_Level3, D.Reason_Level4, D.Action_Level1, D.Action_Level2, D.Action_Level3, D.Action_Level4, D.WET_Id, D.WEMT_Id
...
HASCREW_NOSHIFT_ORIGINAL_INSERT:
  If @MasterUnit Is NULL
    BEGIN
   	 -- Get All The Event Based Waste
      INSERT INTO #TopNDR (Detail_Id, Start_Time, TimeStamp, WasteTimeStamp, Amount, SourcePU, Cause_Comment_Id, R1_Id, R2_Id, R3_Id, R4_Id, A1_Id, A2_Id, A3_Id, A4_Id, Type_Id, Meas_Id, Crew_Desc, Shift_Desc, Prod_Id, EventBased, EventNumber)
        SELECT D.WED_Id, EV.Start_Time, EV.TimeStamp, D.TimeStamp, D.Amount, D.Source_Pu_Id, D.Cause_Comment_Id, D.Reason_Level1, D.Reason_Level2, D.Reason_Level3, D.Reason_Level4, D.Action_Level1, D.Action_Level2, D.Action_Level3, D.Action_Level4, D.WET_Id, D.WEMT_Id
...
NOCREW_NOSHIFT_APPLIED_INSERT:
  ...
  If @MasterUnit Is NULL
    BEGIN
      ...
      INSERT INTO #TopNDR (Detail_Id, Start_Time, TimeStamp, WasteTimeStamp, Amount, SourcePU, Cause_Comment_Id, R1_Id, R2_Id, R3_Id, R4_Id, A1_Id, A2_Id, A3_Id, A4_Id, Type_Id, Meas_Id, Prod_Id, Applied_Prod_Id, EventBased, EventNumber)
        SELECT D.WED_Id, ap.Start_Time, ap.TimeStamp, D.TimeStamp, D.Amount, D.Source_Pu_Id, D.Cause_Comment_Id, D.Reason_Level1, D.Reason_Level2, D.Reason_Level3, D.Reason_Level4, D.Action_Level1, D.Action_Level2, D.Action_Level3, D.Action_Level4, D.WET_Id, D.WEMT_Id
...
HASCREW_NOSHIFT_APPLIED_INSERT:
  ...
  If @MasterUnit Is NULL
    BEGIN
         -- Get All The Event-Based Waste (Get TimeStamp from Events Table VIA Applied_Products_From_Events)
      INSERT INTO #TopNDR (Detail_Id, Start_Time,TimeStamp, WasteTimeStamp, Amount, SourcePU, Cause_Comment_Id, R1_Id, R2_Id, R3_Id, R4_Id, A1_Id, A2_Id, A3_Id, A4_Id, Type_Id, Meas_Id, Crew_Desc, Shift_Desc, Prod_Id, Applied_Prod_Id, EventBased, EventNumber)
        SELECT D.WED_Id, ap.Start_Time, ap.TimeStamp, D.TimeStamp, D.Amount, D.Source_Pu_Id, D.Cause_Comment_Id, D.Reason_Level1, D.Reason_Level2, D.Reason_Level3, D.Reason_Level4, D.Action_Level1, D.Action_Level2, D.Action_Level3, D.Action_Level4, D.WET_Id, D.WEMT_Id
...
-- --------------------------------------------------
--SELECT * FROM @Periods_NPT1
--SELECT * FROM #TopNDR
Delete from #TopNDR where NPT = 1
--SELECT * FROM #TopNDR
  --SET NOCOUNT OFF --commented out because ECR #26008 (mt/8-25-2003) 
