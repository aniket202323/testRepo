...
CREATE PROCEDURE dbo.[spXLA_WasteDT_NoProduct_Bak_177]
 	   @Start_Time  	 DateTime
 	 , @End_Time  	 DateTime
 	 , @PU_Id  	 Int
 	 , @SelectSource 	 Int
...
NOCREW_NOSHIFT_INSERT:
  If @MasterUnit Is NULL
    BEGIN
      ...
      INSERT INTO #TopNDR (Detail_Id, TimeStamp, WasteTimeStamp, Amount, SourcePU, Cause_Comment_Id, R1_Id, R2_Id, R3_Id, R4_Id, A1_Id, A2_Id, A3_Id, A4_Id, Type_Id, Meas_Id, EventBased, EventNumber)
      SELECT D.WED_Id, EV.TimeStamp, D.TimeStamp, D.Amount, D.Source_PU_Id, D.Cause_Comment_Id, D.Reason_Level1, D.Reason_Level2, D.Reason_Level3, D.Reason_Level4, D.Action_Level1, D.Action_Level2, D.Action_Level3, D.Action_Level4, D.WET_Id, D.WEMT_Id, 1, EV.Event_Num 
        FROM Events EV 
...
HASCREW_NOSHIFT_INSERT:
  If @MasterUnit Is NULL
    BEGIN
      -- Get All The Event Based Waste
      INSERT INTO #TopNDR (Detail_Id, TimeStamp, WasteTimeStamp, Amount, SourcePU, Cause_Comment_Id, R1_Id, R2_Id, R3_Id, R4_Id, A1_Id, A2_Id, A3_Id, A4_Id, Type_Id, Meas_Id, EventBased, EventNumber, Crew_Desc, Shift_Desc)
      SELECT D.WED_Id, EV.TimeStamp, D.TimeStamp, D.Amount, D.Source_PU_Id, D.Cause_Comment_Id, D.Reason_Level1, D.Reason_Level2, D.Reason_Level3, D.Reason_Level4, D.Action_Level1, D.Action_Level2, D.Action_Level3, D.Action_Level4, D.WET_Id, D.WEMT_Id, 1, EV.Event_Num , C.Crew_Desc, C.Shift_Desc
        FROM Events EV 
        JOIN Waste_Event_Details D ON D.Pu_Id = EV.Pu_Id AND D.Event_Id = EV.Event_Id
