-- DESCRIPTION: spXLA_WasteSUMM_AP is based on spXLA_WasteSummary_AP. Changes include additional filters 
-- Action1...Action4(MT/8-15-2002) and Crew,Shift Filters(9-10-2002)
CREATE PROCEDURE dbo.[spXLA_WasteSUMM_AP_Bak_177]
 	   @Start_Time  	  	 DateTime
 	 , @End_Time  	  	 DateTime
 	 , @Pu_Id  	  	 Int
 	 , @SelectSource 	  	 Int
  ...
  If @MasterUnit Is NULL
    BEGIN
      ...
      INSERT INTO #TopNDR (TimeStamp, Amount, SourcePU, R1_Id, R2_Id, R3_Id, R4_Id, A1_Id, A2_Id, A3_Id, A4_Id, Type_Id, Meas_Id)
        SELECT ev.TimeStamp, D.Amount, D.Source_Pu_Id, D.Reason_Level1, D.Reason_Level2, D.Reason_Level3, D.Reason_Level4, D.Action_Level1, D.Action_Level2, D.Action_Level3, D.Action_Level4, D.WET_Id, D.WEMT_Id
          FROM Events ev 
...
NOCREW_NOSHIFT_APPLIED_INSERT:
  ...
  If @MasterUnit Is NULL
    BEGIN
      ...
      INSERT INTO #TopNDR (TimeStamp, Amount, SourcePU, R1_Id, R2_Id, R3_Id, R4_Id, A1_Id, A2_Id, A3_Id, A4_Id, Type_Id, Meas_Id)
        SELECT ap.TimeStamp, D.Amount, D.Source_Pu_Id, D.Reason_Level1, D.Reason_Level2, D.Reason_Level3, D.Reason_Level4, D.Action_Level1, D.Action_Level2, D.Action_Level3, D.Action_Level4, D.WET_Id, D.WEMT_Id
