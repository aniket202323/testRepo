CREATE TABLE [dbo].[UserOverrideLayoutDmc] (
    ...
    PRIMARY KEY CLUSTERED ([ComputerComputerDmcType] ASC, [ComputerComputerDmcName] ASC, [UserID] ASC),
    CONSTRAINT [UserOverrideLayoutDmc_ComputerDmc_Relation1] FOREIGN KEY ([ComputerComputerDmcType], [ComputerComputerDmcName]) REFERENCES [dbo].[ComputerDmc] ([ComputerDmcType], [ComputerDmcName])
);
